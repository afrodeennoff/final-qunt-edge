...
export type FirmPlatform = 'Tradovate' | 'Rithmic' | 'MetaTrader 5' | 'cTrader' | 'DXtrade' | 'Rithmic, Tradovate' | 'Tradovate, Rithmic' | 'MetaTrader 4, MetaTrader 5, cTrader' | 'MetaTrader 5, cTrader, DXtrade'
export type FirmPayoutModel = 'Bi-weekly' | 'Weekly' | 'On-demand' | 'Monthly' | '5 Trading Days' | 'On-demand (as fast as 3 days for Express Funded)' | 'Daily (on-demand after eligibility)' | 'On-demand (same-day possible)' | 'On-demand (Select Daily or Flex policies)' | 'On-demand (Elite Daily)' | 'On-demand (daily for Flex, after buffer for Pro)' | 'On-demand, Weekly, Bi-weekly, Monthly (plan-based)' | 'Bi-weekly (after 14 days minimum for funded)' | 'Bi-weekly (24-hour processing guarantee)' | 'Bi-weekly (or on-demand after eligibility)'
export type FirmDrawdownType = 'Trailing' | 'Static' | 'End-of-day' | 'Trailing (Intraday or End-of-Day options)' | 'End-of-day (trailing in Test)' | 'Static (tick-by-tick trailing in some programs)' | 'End-of-day (Intraday options in some)'
...
export const VERIFIED_PROPFIRM_PROFILES: VerifiedPropFirmProfile[] = [
  {
    ...
    profitSplit: '80/20',
    maxAllocation: 'Up to $400K (growth path)',
    shortDesc: 'Futures prop firm with Trader Career Path evaluation, end-of-day drawdown, weekly payouts from $100+, no upfront activation fees (deducted from first profits), and growth to $400K.',
    ...
    sources: [
      ...
      'https://help.earn2trade.com/en/articles/5452472-what-is-the-withdrawal-policy',
    ],
  },
  {
  ...
  },
  {
    ...
    payoutModel: 'On-demand, Weekly, Bi-weekly, Monthly (plan-based)',
    drawdownType: 'Static',
    profitSplit: '80% to 100% (plan and performance dependent)',
    maxAllocation: 'Up to $300K initial, scaling to $2M',
    shortDesc: 'Forex prop firm with multiple challenge models (1-step, 2-step, Instant), flexible payout cycles, high profit splits up to 100%, and scaling to $2M.',
    ...
    sources: [
      ...
      'https://thepropjournalist.com/reviews/fundingpips/',
    ],
  },
  {
    ...
    category: 'Futures',
    platform: 'Tradovate',
    payoutModel: 'On-demand (Elite Daily)',
    drawdownType: 'End-of-day',
    profitSplit: '90/10 (sim), 80/20 (live)',
    maxAllocation: 'Up to $1.5M simulated funds',
    shortDesc: 'Futures prop firm with Elite Daily program, fast on-demand payouts, 90/10 split, and scaling to $1.5M+ simulated funds.',
    referralUrl: 'https://www.toponefutures.com',
    lastVerifiedOn: '2026-06-01',
    confidence: 'high',
    sources: [
      'https://www.toponefutures.com/',
      ...
      'https://propfirmapp.com/prop-firms/top-one-futures',
    ],
  },
]
