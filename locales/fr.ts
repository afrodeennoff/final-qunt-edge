...
export default {
  ...
  'dashboard.teams.leaveConfirm': 'Êtes-vous sûr de vouloir quitter cette équipe ?',
  ...
  'dashboard.teams.onlyAdminCanManage': 'Seuls les administrateurs peuvent gérer les utilisateurs',
  ...
  'import.error.futureDateDescription':
    "Les transactions ne peuvent pas avoir une date d'entrée dans le futur.",
  ...
  filters: {
    ...
    commandMenu: {
      ...
      dateParseError:
        "Impossible d'analyser la date. Essayez d'utiliser le calendrier ou les sélecteurs rapides.",
  ...
  'import.account.pickAccountsDescription': 'Sélectionnez les comptes à importer depuis le fichier',
  ...
  'import.account.selectAccountToView':
    'Veuillez sélectionner au moins un compte pour afficher les trades.',
  ...
  'import.manual.validationError':
    "Veuillez remplir tous les champs requis (Instrument, Quantité, Date d'entrée)",
  'import.manual.invalidQuantity': 'La quantité doit être supérieure à 0',
  'import.manual.noTrades':
    'Aucun trade ajouté pour le moment. Cliquez sur le bouton ci-dessous pour ajouter votre premier trade.',
  ...
  statistics: {
    ...
    performance: {
      ...
      avgWin: 'Gain Moyen',
      avgWinTooltip:
        'Gain moyen par jour gagnant. Peut être utilisé comme référence pour les objectifs de prise de profit.',
      avgLoss: 'Perte Moyenne',
      avgLossTooltip:
        'Perte moyenne par jour perdant. Peut être utilisé comme référence pour les stop loss et les objectifs de prise de profit.',
  ...
  rithmic: {
    ...
    error: {
      ...
      syncDeleteFailed: 'Impossible de supprimer la synchronisation. Veuillez réessayer.',
    ...
    missingCredentialsWarning:
      'Cette synchronisation a été configurée sur un autre appareil. Veuillez vous reconnecter si vous souhaitez synchroniser avec cet appareil également.',
  ...
  'import.steps.manualEntryDescription':
    'Ajoutez des trades manuellement en remplissant le formulaire',
  ...
  tradovateSync: {
    ...
    bulk: {
      ...
      complete:
        'Synchronisation terminée ! {successCount} comptes synchronisés, {totalNewTrades} nouveaux trades importés.',
  ...
  'import.type.manualEntry.description':
    'Ajoutez des trades manuellement en remplissant un formulaire',
  ...
  'accounts.table.scrollHint':
    'Astuce : maintenez Maj et faites défiler la molette pour un défilement horizontal.',
  ...
  blogs: {
    title: 'Blog Éducation Trading',
    description:
      "Expert insights sur la psychologie du trading, la gestion des risques, l'analyse de marché et les mises à jour de la plateforme.",
    backToBlogs: '← Retour aux Blogs',
    noPosts: 'Aucun article de blog pour le moment.',
    noPostsDescription: "Revenez bientôt pour des insights d'experts sur le trading.",
    ...
    admin: {
      ...
      noPosts: 'Aucun article de blog. Créez votre premier article.',
    },
    form: {
      title: 'Titre',
      titlePlaceholder: "Entrez le titre de l'article",
      slug: 'Slug',
      slugPlaceholder: 'slug-url-convivial',
      excerpt: 'Extrait',
      excerptPlaceholder: 'Résumé bref affiché dans les cartes (max 200 caractères)',
      ...
      content: 'Contenu',
      contentPlaceholder: 'Écrivez votre article de blog ici...',
      published: 'Publié',
      save: 'Enregistrer',
      saving: 'Enregistrement...',
      cancel: 'Annuler',
      ...
      excerptRequired: "L'extrait est requis",
