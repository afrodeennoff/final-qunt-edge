...
export default {
  ...
  'dashboard.teams.leaveConfirm': 'Are you sure you want to leave this team?',
  ...
  'import.account.pickAccountsDescription': 'Select which accounts to import from the file',
  ...
  'import.manual.validationError':
    'Please fill in all required fields (Instrument, Quantity, Entry Date)',
  ...
  'import.error.skippedDescription':
    'trade(s) skipped — missing account number or instrument.',
  ...
  'widgets.saveErrorDescription': 'Failed to save widget changes. Please try again.',
  ...
  'widgets.tradingScore.tooltip':
    'Overall trading performance score based on win rate, profit factor, and activity.',
  'widgets.expectancy.title': 'Expectancy',
  'widgets.expectancy.tooltip':
    'Average dollar amount expected per trade based on historical performance.',
  'widgets.riskMetrics.title': 'Risk Metrics',
  'widgets.riskMetrics.tooltip':
    'Advanced risk analysis including Kelly Criterion, Sharpe Ratio, Sortino Ratio, and Max Drawdown.',
  ...
  statistics: {
    ...
    performance: {
      ...
      avgWin: 'Average Win',
      avgWinTooltip:
        'Average profit per winning day. Can be used as a reference for take profit targets.',
      avgLoss: 'Average Loss',
      avgLossTooltip:
        'Average loss per losing day. Can be used as a reference for stop loss and take profit targets.',
  ...
  rithmic: {
    ...
    missingCredentialsWarning:
      'This synchronization was set on another device. Please re-connect if you want to synchronize using this device too.',
  ...
  tradovateSync: {
    ...
    bulk: {
      ...
      complete:
        'Sync complete! {successCount} accounts synced, {totalNewTrades} new trades imported.',
  ...
  blogs: {
    ...
    description:
      'Expert insights on trading psychology, risk management, market analysis, and platform updates.',
    backToBlogs: '← Back to Blogs',
    noPosts: 'No blog posts yet.',
    noPostsDescription: 'Check back soon for expert trading insights.',
    readMore: 'Read More',
    ...
    admin: {
      ...
      noPosts: 'No blog posts yet. Create your first post.',
    },
    form: {
      title: 'Title',
      ...
      excerpt: 'Excerpt',
      excerptPlaceholder: 'Brief summary shown in post cards (max 200 characters)',
