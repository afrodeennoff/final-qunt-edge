    ...
    <div className="w-full space-y-6">
      <Card className="rounded-xl border border-border/30 bg-card/50 shadow-sm">
        ...
        <CardContent className="px-0">
          <div className="space-y-6 rounded-xl border border-border/30 bg-background/70 p-4 sm:p-6">
      ...
      <Card className="rounded-xl border border-border/30 bg-card/50 shadow-sm">
        ...
        <CardContent className="px-0">
          <div className="rounded-xl border border-border/30 bg-background/70">
            {isLoading ? (
