...
const loadingShell = (
  <div
    className="h-full w-full animate-pulse rounded-2xl border border-border/35 bg-[radial-gradient(circle_at_12%_0%,hsl(var(--foreground)/0.12),hsl(var(--background)/0.85)_58%)] backdrop-blur-md"
    aria-hidden="true"
  />
)
