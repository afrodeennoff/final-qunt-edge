...
export const ShareButton = forwardRef<HTMLButtonElement, ShareButtonProps>(
 ...
 <div className="border-border/30 rounded-lg bg-[oklch(0.65_0.22_260/0.03)] p-2">
 <Calendar
 mode="single"
 ...
 <div className="shrink-0 px-3 sm:px-6 py-3 sm:py-4 border-t bg-background/95 supports-backdrop-filter:bg-background/60">
 <DialogFooter>
