...
export function AccountCoin({
  ...
  const content = (
    <div
      ...
      className={cn(
        "relative flex min-w-0 w-full max-w-full items-center gap-3 rounded-lg border bg-white/[0.02] px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)]",
        "sm:w-full sm:min-w-[120px] sm:max-w-full",
        "transition-all duration-200 ease-out",
        draggableEnabled && !disabled && "cursor-grab active:cursor-grabbing",
        "hover:border-primary/50 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_8px_32px_-8px_rgba(0,0,0,0.4)]",
