...
export function AccountCoin({
 ...
 className={cn("relative flex min-w-0 w-full max-w-full items-center gap-3 rounded-lg border bg-primary/[0.03] px-3 py-2 shadow-[inset_0_1px_0_hsl(var(--primary)/0.06),0_4px_16px_-4px_rgba(0,0,0,0.3)]","sm:w-full sm:min-w-[120px] sm:max-w-full","transition-[opacity,background-color,border-color] duration-200 ease-out",
