...
export function AccountGroupBoard() {
 ...
 <div className="rounded-lg border bg-[oklch(0.65_0.22_260/0.03)] shadow-[inset_0_1px_0_oklch(0.65_0.22_260/0.06),0_4px_16px_-4px_rgba(0,0,0,0.3)]">
 ...
 <div
 key={group.id}
 className={cn("relative mb-3 overflow-hidden rounded-lg border bg-background",
 ...
 className={cn("h-8 w-fit px-3 text-sm font-semibold leading-8",
 ...
 >
 <span
 className={cn("flex h-5 w-5 items-center justify-center rounded-sm border",
