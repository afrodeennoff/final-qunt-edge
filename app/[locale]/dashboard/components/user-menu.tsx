...
export default function UserMenu({ variant = 'sidebar' }: { variant?: MenuVariant }) {
 ...
 className={cn("flex items-center gap-2 cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background",
 variantClass.trigger
 )}
 >
 <div className="relative flex-none">
 <Avatar className={cn("rounded-lg transition-transform hover:scale-105",
 variantClass.avatar
 )}>
 <AvatarImage src={userAvatarUrl} />
 <AvatarFallback className={cn("uppercase text-xs rounded-lg",
 variantClass.avatarFallback
 )}>
 {userInitial}
 </AvatarFallback>
 </Avatar>
 <SubscriptionBadge className={cn("absolute -bottom-1 -right-1 px-1 py-0 text-[10px] leading-3",
