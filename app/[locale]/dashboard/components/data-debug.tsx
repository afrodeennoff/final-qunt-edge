...
export function DataDebug() {
 ...
 className="rounded-full bg-background/80 border-border/14 hover:bg-foreground/10 shadow-[inset_0_1px_0_hsl(var(--primary)/0.08),0_16px_48px_-16px_rgba(0,0,0,0.5)]"
 >
