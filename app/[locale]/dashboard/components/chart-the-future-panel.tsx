...
function ChartPanel() {
 ...
 return (
 <section className="rounded-xl border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.03)] overflow-hidden">
 <header className="flex flex-wrap items-center gap-2 border-b border-[oklch(0.65_0.22_260/0.08)] p-3">
 <select
 value={symbol}
 onChange={(event) => setSymbol(event.target.value as SymbolValue)}
 className="h-8 rounded-md border border-input bg-background px-2 text-[10px] font-bold uppercase tracking-widest text-foreground/95 outline-none hover:bg-[oklch(0.65_0.22_260/0.045)] transition-colors"
 >
 {SYMBOLS.map((item) => (
...
function AssistantPanel() {
 ...
 return (
 <aside className="flex min-h-[500px] flex-col rounded-xl border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.03)] overflow-hidden">
 <div className="flex items-center justify-between border-b border-[oklch(0.65_0.22_260/0.08)] p-4">
 ...
 <div
 key={message.id}
 className={cn("rounded-lg border-[oklch(0.65_0.22_260/0.08)] px-3 py-2 text-xs leading-relaxed",
 message.role ==="user"
 ?"border-primary/20 bg-primary/10 text-foreground/95"
 :"border-[oklch(0.65_0.22_260/0.08)] bg-muted/40 text-muted-foreground",
 )}
 >
 {message.text}
 </div>
 ...
 <div className="border-t border-[oklch(0.65_0.22_260/0.08)] p-3">
 <div className="flex items-center gap-2 rounded-lg border border-[oklch(0.65_0.22_260/0.08)] bg-muted/20 px-2 py-1.5 focus-within:border-primary/50 transition-colors">
 <input
 value={draft}
