...
function TradeTableReviewComponent({ tradesParam, config }: TradeTableReviewProps) {
 ...
 return (
 <Card
 className="flex h-full w-full flex-col border-white/[0.08] bg-white/[0.080] shadow-[0_20px_40px_-32px_hsl(var(--foreground)/0.55)]"
 style={cardStyle}
 >
 {showHeader && (
 ...
 <thead className="sticky top-0 z-10 border-b bg-muted/90 shadow-xs [&_tr]:border-b">
 ...
 <td
 key={columnId || index}
 className={cn("p-4 align-middle whitespace-nowrap px-3 py-3 text-sm font-semibold border-r border-border/20 last:border-r-0 first:border-l",
 )}
 ...
 <td
 key={columnId || index}
 className={cn("p-4 align-middle whitespace-nowrap px-3 py-3 text-sm border-r border-border/20 last:border-r-0",
 )}
 style={{ width: column.getSize() }}
 />
 );
 ...
 <td
 key={columnId}
 className={cn("p-4 align-middle whitespace-nowrap px-3 py-3 text-sm font-semibold text-right border-r border-border/20 last:border-r-0",
 )}
 style={{ width: column.getSize() }}
 >
 <span
 ...
 <CardFooter className="flex items-center justify-between border-t border-white/[0.08] bg-background/80 px-4 py-3">
