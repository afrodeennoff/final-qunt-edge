...
export function BulkEditPanel({ 
 ...
 return (
 <Card className={cn("fixed left-2 right-2 z-50 max-h-[calc(100dvh-env(safe-area-inset-bottom)-0.5rem)] overflow-y-auto border border-border/40 shadow-sm transition-[opacity,background-color,border-color] duration-150 ease-out sm:bottom-[calc(env(safe-area-inset-bottom)+1rem)] sm:left-auto sm:right-4 sm:w-96","bottom-[calc(env(safe-area-inset-bottom)+0.5rem)]",
