...
function DraggableAccountCard({
 ...
 {...attributes}
 {...listeners}
 className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing p-1 rounded bg-background/80 border"
 >
...
function AccountsOverviewComponent({
 ...
 >
 <CardHeader
 className={cn("flex flex-row items-center justify-between gap-0 border-b shrink-0",
