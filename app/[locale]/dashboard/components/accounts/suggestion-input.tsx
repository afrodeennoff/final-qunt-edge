...
export default function EnhancedInput({
 ...
 type="button"
 onClick={clearInput}
 className="mr-1 rounded-full p-1 text-muted-foreground hover:bg-background/35 hover:text-accent-foreground"
 ...
 <ul
 ref={suggestionsRef}
 className={cn("absolute z-10 mt-1 w-full overflow-auto rounded-md border py-1 text-sm shadow-[0_4px_16px_-8px_rgba(0,0,0,0.5)] max-h-[200px]","border-input bg-background","text-foreground"
 )}
 role="listbox"
 >
 ...
 className={cn("cursor-pointer px-3 py-2","hover:bg-background/35 hover:text-accent-foreground",
 selectedIndex === index ?"bg-background/35 text-accent-foreground" :""
 )}
