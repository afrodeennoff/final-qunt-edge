...
export function AccountCard({ account, onClick, size = 'large' }: AccountCardProps) {
 ...
 onClick={onClick}
 >
 <CardHeader className={cn("flex-none pb-2",
 size === 'small' || size === 'small-long' ?"p-2" :"p-3"
 )}>
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2 min-w-0 w-full">
 <div className="truncate w-full">
 <CardTitle className={cn("truncate flex items-center gap-2 w-full",
 ...
 <div className={cn("self-center ml-2 shrink-0 font-terminal",
 ...
 <p className={cn("text-muted-foreground truncate font-mono",
 size === 'small' || size === 'small-long' ?"text-[10px]" :"text-[10px]"
 )}>
 {account.number}
 </p>
 ...
 <CardContent className={cn("flex-1 pt-0",
 size === 'small' || size === 'small-long' ?"p-2 space-y-1.5" :"p-3 space-y-2"
 )}>
 <div className="flex justify-between items-baseline border-b border-[oklch(0.65_0.22_260/0.08)] pb-2">
 <span className={cn("text-muted-foreground uppercase tracking-widest font-bold",
 size === 'small' || size === 'small-long' ?"text-[9px]" :"text-[10px]"
 )}>{t('propFirm.card.balance')}</span>
 <span className={cn("font-black truncate ml-2 text-card-foreground",
 ...
 <Progress
 value={progress}
 className={cn("bg-[oklch(0.65_0.22_260/0.06)]",
 ...
 progress <= 80 ?"opacity-85 shadow-none chart-positive-emphasis" :"opacity-100 shadow-none chart-positive-emphasis"
 )}
 />
 </div>
 ...
 <span className={cn("font-black truncate ml-2",
 ...
 <div className="space-y-1 pt-2 border-t border-[oklch(0.65_0.22_260/0.08)] mt-2">
 <div className="flex justify-between text-[10px] uppercase font-bold tracking-tight">
 ...
 <p className={cn("pt-2 text-center font-medium italic text-muted-foreground",
