...
function MobileCalendarPnlComponent({ calendarData }: { calendarData: CalendarData }) {
 ...
 <div className={cn("mt-1 text-lg font-black tracking-tight",
 ...
 >
 <div
 className={cn("pointer-events-none absolute inset-0 rounded-lg",
 dayPnl > 0 &&"bg-semantic-success/20",
 dayPnl < 0 &&"bg-semantic-error/20"
 )}
 style={{ opacity: intensity * 0.8 }}
 />
 <div className={cn("inline-flex h-6 w-6 items-center justify-center rounded-md border border-border/55 bg-white/[0.092] text-xs font-semibold",
 ...
 <>
 <div
 className={cn("truncate text-[10px] font-bold",
