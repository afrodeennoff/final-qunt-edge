...
function RenewalBadge({ renewals }: { renewals: Account[] }) {
 ...
 <PopoverContent
 className="w-[320px] sm:w-[380px] md:w-[420px] max-w-[90vw] p-0 z-50 border shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_16px_48px_-16px_rgba(0,0,0,0.5)] bg-white/[0.096] border-border/55"
 align="start"
 side="right"
 sideOffset={8}
 onClick={(e) => e.stopPropagation()}
...
export default function CalendarPnl({ calendarData, hideFiltersOnMobile = false }: CalendarPnlProps) {
 ...
 <div className={cn("text-xl font-black tracking-tight sm:text-2xl",
 ...
 <div className={cn("invisible text-center text-[11px] font-semibold",
 !isCurrentMonth &&"opacity-50"
 )}>$0</div>
 )}
 <div className={cn("truncate text-center text-[8px] font-medium uppercase tracking-wider text-muted-foreground",
 !isCurrentMonth &&"opacity-50"
 )}>
 {dayData
