...
function RiskRewardRatioCardInner({ size = 'tiny' }: RiskRewardRatioCardProps) {
    ...
    return (
      ...
      >
        <div className="mx-auto inline-flex items-center justify-center gap-2.5 text-center">
          <Scale className="h-4 w-4 shrink-0 text-v2-text-primary" />
          <span className="micro-sans shrink-0 text-xs font-bold uppercase tracking-[0.18em] text-v2-text-secondary">RR</span>
  ...
  return (
    <WidgetShell
      title="Risk/Reward"
      icon={<Scale className="h-3.5 w-3.5 text-v2-text-secondary" />}
    ...
    >
      <div className="flex items-end justify-center gap-2 px-1">
        <span className="micro-sans text-[11px] font-semibold uppercase tracking-[0.18em] text-v2-text-secondary">RR</span>
        <span className="micro-sans text-[24px] font-black leading-none tracking-tight text-v2-text-primary">
          {riskRewardRatio.toFixed(2)}
        </span>
      </div>
      ...
      <div className="gap-1.5">
        <div className="flex items-center justify-between text-[10px] font-semibold uppercase tracking-wider">
          <span className="text-v2-text-secondary">Avg Win</span>
          <span className="text-v2-text-primary">${avgWin.toFixed(2)}</span>
        </div>
        <div className="flex items-center justify-between text-[10px] font-semibold uppercase tracking-wider">
          <span className="text-v2-text-secondary">Avg Loss</span>
          <span className="text-v2-text-secondary">${avgLoss.toFixed(2)}</span>
        </div>
        <TooltipProvider delayDuration={100}>
          <Tooltip>
            <TooltipTrigger asChild>
