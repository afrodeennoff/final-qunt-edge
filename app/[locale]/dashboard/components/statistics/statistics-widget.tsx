    ...
    >
      <div className="grid h-full grid-cols-2">
          ...
          <div className={cn(
            ...
            <h3 className="font-terminal text-[10px] font-bold uppercase tracking-widest mb-1.5 text-muted-foreground">{t('statistics.profitLoss.title')}</h3>
            <div className="flex-1 flex flex-col justify-center gap-0.5">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs font-medium text-muted-foreground font-terminal">{formatCurrency(cumulativeFees)}</span>
              </div>

              {/* Payouts */}
              <div className="flex justify-between items-center">
                <span className="text-muted-foreground text-xs">- {t('statistics.profitLoss.payouts')} ({nbPayouts})</span>
                <span className="text-xs font-medium text-muted-foreground font-terminal">{formatCurrency(totalPayouts)}</span>
              </div>
          ...
          <div className={cn(
            ...
            <h3 className="font-terminal text-[10px] font-bold uppercase tracking-widest mb-1.5 text-muted-foreground">{t('statistics.performance.title')}</h3>
          ...
          <div className={cn(
            ...
            <h3 className="font-terminal text-[10px] font-bold uppercase tracking-widest mb-1.5 text-muted-foreground">{t('statistics.activity.title')}</h3>
            <div className="flex-1 flex flex-col justify-center gap-1.5">
              <div className="flex justify-between items-center">
          ...
          <div className={cn(
            ...
            <h3 className="font-terminal text-[10px] font-bold uppercase tracking-widest mb-1.5 text-muted-foreground">{t('statistics.distribution.title')}</h3>
            <div className="flex-1 flex flex-col justify-center gap-1.5">
