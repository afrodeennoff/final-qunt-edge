...
const mappings: { [key: string]: string } = {"ContractName":"instrument","Size":"quantity","PnL":"pnl","Fees":"commission","Type":"side","Id":"entryId","EntryPrice":"entryPrice","EnteredAt":"entryDate","ExitPrice":"closePrice","ExitedAt":"closeDate",
}
...
export default function TopstepProcessor({ headers, csvData, processedTrades, setProcessedTrades }: PlatformProcessorProps) {
 ...
 <TableCell className={trade.pnl ? trade.pnl < 0 ? 'text-semantic-error' : 'text-foreground/95' : ''}>
 {trade.pnl?.toFixed(2)}
 </TableCell>
