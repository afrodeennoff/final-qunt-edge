...
const atasMappings: Record<string, keyof Trade> = {
 ...
 instrument:"instrument","open time":"entryDate","open price":"entryPrice","open volume":"quantity","close time":"closeDate","close price":"closePrice",
 pnl:"pnl",
 comment:"comment",
};
...
export default function AtasProcessor({
 ...
 columns: ["expand","accounts","instrument","entryDate","entryTime","closeDate","closeTime","quantity","pnl","commission",
 ],
 groupTrades: false,
 showHeader: false,
