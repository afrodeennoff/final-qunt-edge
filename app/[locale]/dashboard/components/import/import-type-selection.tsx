...
export default function ImportTypeSelection({ selectedType, setSelectedType, setIsOpen }: ImportTypeSelectionProps) {
 ...
 >
 <div className="flex items-center justify-center gap-3 p-3 rounded-xl bg-v2-bg-surface/95 border border-v2-border shadow-[0_4px_16px_-8px_rgba(0,0,0,0.5)] shadow-v2-bg-base/50">
