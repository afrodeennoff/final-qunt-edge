...
const englishMappings: { [key: string]: string } = {"Account":"accountNumber","Entry name":"entryId","Entry price":"entryPrice","Entry time":"entryDate","Exit name":"closeId","Exit price":"closePrice","Exit time":"closeDate","Instrument":"instrument","Market pos.":"side","Profit":"pnl","Qty":"quantity","Commission":"commission",
}

const frenchMappings: { [key: string]: string } = {"Compte":"accountNumber","Nom d'entrée":"entryId","Prix d'entrée":"entryPrice","Heure d'entrée":"entryDate","Nom de la sortie":"closeId","Prix de sortie":"closePrice","Heure de sortie":"closeDate","Instrument":"instrument","Pos. marché.":"side","Qté":"quantity","Commission":"commission","Profit":"pnl",
}
...
export default function NinjaTraderPerformanceProcessor({ headers, csvData, setProcessedTrades }: PlatformProcessorProps) {
 ...
 <TableRow>
 <TableHead className="whitespace-nowrap px-3 py-2 text-left text-sm font-semibold bg-muted/90 border-r border-white/[0.06] last:border-r-0 first:border-l">
 Account
 </TableHead>
 <TableHead className="whitespace-nowrap px-3 py-2 text-left text-sm font-semibold bg-muted/90 border-r border-white/[0.06] last:border-r-0 first:border-l">
 Instrument
 ...
 <p className={`text-lg font-bold ${totalPnL >= 0 ? 'text-semantic-success' : 'text-semantic-error'}`}>
 ${totalPnL.toFixed(2)}
 </p>
 </div>
 <div>
