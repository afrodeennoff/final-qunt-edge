              ...
              {trades.length > 0 ? (
                trades.map((trade) => (
                  ...
                  >
                    ...
                    <TableCell className={`whitespace-nowrap px-3 py-2 text-sm border-r border-border/50 last:border-r-0 first:border-l ${trade.pnl && trade.pnl >= 0 ? 'text-semantic-success' : 'text-semantic-error'}`}>
                      {trade.pnl?.toFixed(2)}
                    </TableCell>
                    <TableCell className="whitespace-nowrap px-3 py-2 text-sm border-r border-border/50 last:border-r-0 first:border-l">
