...
export function PlatformItem({
 ...
 className={cn("data-[selected='true']:bg-transparent","flex items-stretch gap-4 ml-6 border-l-2 border-muted pl-4 transition-[opacity,background-color,border-color] duration-200 rounded-none",
