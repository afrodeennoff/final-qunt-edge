...
function PlatformCardInner({
 ...
 isSelected &&"border-v2-accent shadow-[inset_0_1px_0_hsl(var(--primary)/0.08),0_16px_48px_-16px_rgba(0,0,0,0.5)] shadow-v2-accent/20",
 ...
 <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-v2-border/50 bg-v2-bg-base/80 p-2 shadow-[inset_0_1px_0_hsl(var(--primary)/0.06),0_4px_16px_-4px_rgba(0,0,0,0.3)] transition-transform group-hover:scale-105">
 {platform.logo.path && (
