...
const RadarChartCard = dynamic(() => import('./components/RadarChartCard'), {
  loading: () => (
    <div className="rounded-xl border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.02)] p-3">
      ...
      <div className="animate-page-enter space-y-4 sm:space-y-5">
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1.6fr)_minmax(380px,0.95fr)] 2xl:grid-cols-[minmax(0,1.8fr)_minmax(420px,1fr)] 2xl:gap-8">
            ...
            >
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div className="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-start">
                  <Avatar className="h-20 w-20 shrink-0 rounded-3xl border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.015)] sm:h-24 sm:w-24">
                ...
                <div className={cn(insetPanelClassName, 'p-4 sm:p-4')}>
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      ...
                      <div className="rounded-2xl border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.02)] p-3.5">
                        <p className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">
                          Active session
                        </p>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
                      ...
                      >
                        <SelectTrigger className="h-10 w-full border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.02)] text-sm text-foreground">
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button
                            type="button"
                            variant="outline"
                            className="h-10 justify-start border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.02)] text-sm text-foreground hover:bg-background/85"
                          >
                  ...
                  {activeAccountLabels.length > 0 ? (
                    <div className="flex flex-wrap gap-2">
                      {activeAccountLabels.map((accountLabel) => (
                        <span
                          key={accountLabel}
                          className="rounded-full border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.02)] px-3 py-1.5 text-xs font-medium text-foreground"
                        >
                          {accountLabel}
                        </span>
                      ))}
          ...
          >
            ...
            <div className="border-t border-[oklch(0.65_0.22_260/0.06)]" />
                ...
                {[1, 2, 3].map((index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="h-3 w-3 rounded-full bg-[oklch(0.65_0.22_260/0.03)]" />
