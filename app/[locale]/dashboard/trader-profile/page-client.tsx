...
export default function TraderProfilePage() {
 ...
 <div className="h-3.5 w-3.5 rounded-full bg-[oklch(0.65_0.22_260/0.045)]" />
 <div className="space-y-1">
 <div className="h-3 w-20 rounded bg-[oklch(0.65_0.22_260/0.045)]" />
 <div className="h-2 w-32 rounded bg-white/[0.045]" />
 </div>
 </div>
 <div className="h-3 w-12 rounded bg-[oklch(0.65_0.22_260/0.045)]" />
 </div>
 ))}
 </div>
 ) : null}
