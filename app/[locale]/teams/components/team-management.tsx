...
export function TeamManagement({
 ...
 return (
 <Card key={team.id} className={cn("cursor-pointer transition-all duration-200 border-v2-border/50 bg-v2-bg-surface/60 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_8px_32px_-8px_rgba(0,0,0,0.4)] hover:border-v2-accent/30",
 isActive 
