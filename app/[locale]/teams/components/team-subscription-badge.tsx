...
export async function TeamSubscriptionBadge({ 
 ...
 <Badge
 variant="secondary"
 className={cn("px-2 py-0.5 text-xs whitespace-nowrap","border-transparent bg-muted text-muted-foreground",
 className
 )}
 >
 {t('pricing.free.name')}
 ...
 <Badge
 variant="secondary"
 className={cn("px-2 py-0.5 text-xs whitespace-nowrap cursor-help transition-colors",
