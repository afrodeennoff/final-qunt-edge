...
function CustomTooltip({
  ...
  return (
    <div className="rounded-xl border border-white/[0.8] bg-popover/95 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_16px_48px_-16px_rgba(0,0,0,0.5)] backdrop-blur">
