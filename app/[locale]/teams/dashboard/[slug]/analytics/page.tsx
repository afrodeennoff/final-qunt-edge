  ...
  if (loading) {
    return (
      <div className="space-y-4">
        <div className="h-28 animate-pulse rounded-xl border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.065_0.008_260/0.92)]" />
        <div className="h-80 animate-pulse rounded-xl border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.065_0.008_260/0.92)]" />
      </div>
    )
  }
  ...
  if (!data || data.chartData.length === 0) {
    return (
      <section className="space-y-6">
        ...
        <Card className="border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.03)]">
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-12">
        <Card data-chart-surface="modern" className="border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.03)] xl:col-span-8">
          <CardHeader>
        ...
        <Card className="border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.03)] xl:col-span-4">
          <CardHeader>
