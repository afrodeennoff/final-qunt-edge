        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.08fr)_360px] lg:gap-8">
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href={`/${locale}/support`}
                className="inline-flex items-center rounded-full border border-white/[0.12] bg-white/[0.4] px-6 py-3 text-[13px] font-medium tracking-[-0.01em] text-foreground/76 hover:border-white/[0.18] hover:bg-white/[0.8] hover:text-foreground/95"
              >
                Contact Sales
              </Link>
            </div>
          ...
          <div className="grid gap-3">
            <div className="rounded-[1.8rem] border border-white/[0.8] bg-white/[0.4] p-5">
