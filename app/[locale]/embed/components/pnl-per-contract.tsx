...
interface CustomTooltipProps {
  active?: boolean;
  payload?: Array<{ value: number; name: string; payload: { averagePnl: number; totalPnl: number; tradeCount: number; totalContracts: number } }>;
      ...
      <CardV2Header className="flex flex-row items-center justify-between gap-0 border-b shrink-0 p-3 sm:p-4 h-[56px]">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-1.5">
            <CardV2Title className="line-clamp-1 text-base">{t('embed.pnlPerContract.title')}</CardV2Title>
            <Popover>
