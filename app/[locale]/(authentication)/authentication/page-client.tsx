...
export default function AuthenticationPageClient() {
 ...
 <div className="w-full overflow-hidden rounded-[2rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(7,7,7,0.96),rgba(2,2,2,0.94))] shadow-[0_0_0_0.5px_rgba(255,255,255,0.05),0_40px_100px_-48px_rgba(0,0,0,0.98)]">
 ...
 >
 <div className="mb-7 inline-flex items-center gap-3 rounded-[1.4rem] border border-white/[0.08] bg-white/[0.04] px-4 py-3 shadow-[0_0_0_0.5px_rgba(255,255,255,0.05)]">
 ...
 <div
 key={point.title}
 className="rounded-[1.5rem] border border-white/[0.08] bg-white/[0.03] px-4 py-4 shadow-[0_0_0_0.5px_rgba(255,255,255,0.04),0_16px_40px_-30px_rgba(0,0,0,0.9)]"
 >
 <div className="flex items-start gap-3">
 <div className="mt-0.5 rounded-[1rem] border border-white/[0.08] bg-white/[0.04] p-2.5 shadow-[0_0_18px_rgba(255,255,255,0.08)]">
 ...
 <section className="flex items-center justify-center border-t border-white/[0.08] p-6 sm:p-8 lg:border-t-0 lg:p-10">
 <motion.div
 initial={{ opacity: 0, y: 10 }}
 animate={{ opacity: 1, y: 0 }}
 ...
 >
 <div className="mb-6 rounded-[1.6rem] border border-white/[0.08] bg-white/[0.04] p-5 shadow-[0_0_0_0.5px_rgba(255,255,255,0.04),0_18px_40px_-28px_rgba(0,0,0,0.9)]">
