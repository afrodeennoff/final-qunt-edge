            ...
            <section className="relative overflow-hidden p-6 sm:p-8 lg:border-r lg:border-primary/10 lg:p-10 xl:p-12">
              ...
              <div className="flex items-center justify-between gap-3">
                <Link
                  ...
                  className={cn(
                    unifiedGhostActionClassName,
                    'px-4 py-2 text-[11px] uppercase tracking-[0.18em] text-foreground/78',
                  )}
                >
              ...
              <div className="auth-entrance-1 mt-10 max-w-[39rem] lg:mt-14">
                ...
                <div className="mt-4 inline-flex items-center gap-3 rounded-[1.4rem] border border-primary/12 bg-primary/[0.05] px-4 py-3 shadow-[0_20px_40px_-32px_rgba(0,0,0,0.88)]">
                  ...
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-foreground/72">
                      Daily trading access
                    </p>
                    <p className="pt-1 text-sm text-foreground/46">Secure entry for the full workspace.</p>
                  </div>
                </div>
                ...
                <p className={cn(unifiedBodyCopyClassName, 'mt-5 max-w-xl text-foreground/58')}>
                  ...
                  {VALUE_POINTS.map((point) => (
                    <div key={point.title} className={cn(unifiedMetricPanelClassName, 'p-4')}>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-semibold tracking-[-0.01em] text-foreground/95">
                            {point.title}
                          </p>
                          <p className="mt-1.5 text-xs leading-[1.65] text-foreground/52">
                            {point.description}
                          </p>
                        </div>
                      </div>
                ...
                <div className={cn(unifiedSectionPanelClassName, 'p-5 sm:p-6')}>
                  <div className="mb-5 flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h2 className="pt-2 text-2xl font-semibold tracking-tight text-foreground/95">
                        Sign in to continue
                      </h2>
                  ...
                  <p className="mt-8 text-center text-[11px] leading-relaxed text-foreground/42">
                    ...
                    <Link
                      href={`/${locale}/terms`}
                      className="text-foreground/95 underline decoration-border/80 underline-offset-4 hover:text-foreground/95"
                    >
