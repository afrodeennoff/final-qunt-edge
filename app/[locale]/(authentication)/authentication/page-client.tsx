  ...
  return (
    <main className="qe-v2-app-shell relative min-h-screen overflow-hidden bg-background text-foreground/95">
      ...
      <div className="relative mx-auto flex min-h-screen w-full items-center justify-center px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8 xl:px-10">
        <div className="w-full overflow-hidden rounded-[2rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(7,9,16,0.96),rgba(4,5,10,0.94))] shadow-[0_0_0_0.5px_rgba(180,210,255,0.08),0_40px_100px_-48px_rgba(4,10,24,0.98),0_0_120px_-48px_oklch(0.65_0.22_260/0.18)] backdrop-blur-2xl">
