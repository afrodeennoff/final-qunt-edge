      ...
      <section id="matchup" className="scroll-mt-[120px] bg-[hsl(var(--mk-surface)/0.3)] py-16 sm:py-20">
        <div className="mx-auto max-w-[1360px] px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-3xl font-semibold text-foreground/95 sm:text-4xl">Compare prop firm tradeoffs before you pay</h2>
          ...
          <div className="mx-auto mb-6 grid max-w-2xl grid-cols-3 gap-3">
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] p-3 text-center">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.66)] p-5">
              <h3 className="text-base font-semibold text-foreground/95">1. Set max month-one spend</h3>
              <p className="mt-2 text-sm text-muted-foreground">Include evaluation fee, any likely retry budget, and platform costs.</p>
            </div>
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.66)] p-5">
              <h3 className="text-base font-semibold text-foreground/95">2. Pick executable drawdown</h3>
              <p className="mt-2 text-sm text-muted-foreground">Favor rule sets you can consistently follow during volatile sessions.</p>
            </div>
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.66)] p-5">
              <h3 className="text-base font-semibold text-foreground/95">3. Align payout cadence</h3>
      ...
      <section id="cost-planner" className="scroll-mt-[120px] py-16 sm:py-20">
        <div className="mx-auto max-w-[1360px] px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-3xl font-semibold text-foreground/95 sm:text-4xl">Model your evaluation cost before you start</h2>
          ...
          <div className="mx-auto mb-6 grid max-w-xl gap-2 sm:grid-cols-3">
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] p-3 text-center">
              ...
              <p className="mt-1 font-semibold text-foreground/95">Fees + resets</p>
            </div>
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] p-3 text-center">
              <p className="text-[11px] uppercase tracking-[0.12em] text-muted-foreground">Output Layer</p>
              <p className="mt-1 font-semibold text-foreground/95">Net after costs</p>
            </div>
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] p-3 text-center">
              <p className="text-[11px] uppercase tracking-[0.12em] text-muted-foreground">Risk Layer</p>
              <p className="mt-1 font-semibold text-foreground/95">Ratio signal</p>
            </div>
          </div>
          <EvalCostCalculator />
          <div className="mt-6 rounded-2xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.82)] p-5 sm:p-6">
            <h3 className="text-lg font-semibold text-foreground/95">Interpretation tips</h3>
      ...
      <section id="playbooks" className="scroll-mt-[120px] bg-[hsl(var(--mk-surface)/0.3)] py-16 sm:py-20">
        <div className="mx-auto max-w-[1360px] px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-3xl font-semibold text-foreground/95 sm:text-4xl">Prop firm playbooks for disciplined execution</h2>
          ...
          <div className="mx-auto mb-6 grid max-w-xl gap-2 sm:grid-cols-3">
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] p-3 text-center">
              ...
              <p className="mt-1 font-semibold text-foreground/95">Execution Quality</p>
            </div>
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] p-3 text-center">
              <p className="text-[11px] uppercase tracking-[0.12em] text-muted-foreground">Mode</p>
              <p className="mt-1 font-semibold text-foreground/95">Actionable Steps</p>
            </div>
            <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] p-3 text-center">
              <p className="text-[11px] uppercase tracking-[0.12em] text-muted-foreground">Outcome</p>
              <p className="mt-1 font-semibold text-foreground/95">Lower Rule Breaches</p>
            </div>
          </div>
      ...
      <section id="help" className="scroll-mt-[120px] py-16 sm:py-20">
        <div className="mx-auto max-w-[1360px] px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-3xl font-semibold text-foreground/95 sm:text-4xl">Deals FAQ</h2>
          ...
          <Accordion type="single" collapsible className="w-full">
            {faqItems.map((item, index) => (
              <AccordionItem key={item.question} value={`item-${index}`} className="mb-3 rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.84)] px-4">
                <AccordionTrigger className="py-4 text-left text-base font-semibold text-foreground/95 hover:no-underline">
                  {item.question}
                </AccordionTrigger>
...
function BiggestDealsCarousel({
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-[hsl(var(--mk-bg-0))] px-6 pb-8 pt-7 text-[hsl(var(--mk-text))] sm:px-8 sm:pb-10 sm:pt-8 lg:px-10 lg:pb-14 lg:pt-10">
      ...
      <div className="relative mt-8">
        ...
        <div className="relative mx-auto w-full max-w-[1020px] rounded-2xl bg-[hsl(var(--mk-bg-0))] px-6 py-8 sm:px-8 sm:py-9 shadow-[0_28px_70px_-48px_hsl(var(--foreground)/0.32)]">
...
function BackgroundDealTeaser({
  ...
  return (
    <div
      className={`w-[390px] rounded-2xl border border-[hsl(var(--mk-border)/0.3)] bg-[hsl(var(--mk-bg-0))] px-6 py-7 opacity-15 ${
...
function BrowseDealsSection({
  ...
  return (
    <section className="rounded-2xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.84)] p-5 shadow-[0_24px_60px_-46px_hsl(var(--foreground)/0.9)] sm:p-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-tight text-foreground/95">The active board</h2>
        </div>
      ...
      {browseDeals.length > 0 ? (
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.66)] p-8 text-center text-sm text-muted-foreground">
...
function DealsHero({
  ...
  return (
    <section className="grid gap-6 rounded-2xl bg-[linear-gradient(160deg,hsl(var(--mk-surface)/0.88),hsl(var(--background)/0.7))] p-5 shadow-[0_34px_90px_-62px_hsl(var(--foreground)/0.95)] lg:grid-cols-[1.1fr_0.9fr] lg:p-8">
      <div>
...
function DealsFilterPanel({
  ...
  return (
    <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
      <div className="rounded-2xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.84)] p-5 shadow-[0_26px_60px_-44px_hsl(var(--foreground)/0.9)]">
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto]">
          <div className="relative">
            ...
            <input
              ...
              className="h-11 w-full rounded-full border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] pl-11 pr-4 text-sm text-foreground/95 outline-none transition-colors placeholder:text-muted-foreground/60 focus:border-primary/35"
            />
          </div>
              ...
              <button
                ...
                className={`rounded-full border px-3 py-1.5 text-xs font-medium transition-colors ${
                  selectedDiscount === option.value
                    ...
                    : 'border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.65)] text-muted-foreground hover:text-foreground/95'
                }`}
              >
                {option.label}
              </button>
        ...
        {hasActiveFilters ? (
          <div className="mt-4 flex items-center justify-between gap-3 rounded-xl border border-dashed border-[hsl(var(--mk-border)/0.42)] bg-[hsl(var(--mk-surface-muted)/0.6)] px-4 py-3 text-sm text-muted-foreground">
            <span>The deal board is narrowed right now. Reset to return to the full live tape.</span>
            <button
              type="button"
              onClick={onResetFilters}
              className="rounded-full border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.76)] px-3 py-1.5 text-xs font-medium text-foreground/95 transition-colors hover:bg-[hsl(var(--mk-surface-muted)/0.72)]"
            >
              Reset filters
            </button>
          </div>
      ...
      <div className="rounded-2xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.84)] p-5 shadow-[0_26px_60px_-44px_hsl(var(--foreground)/0.9)]">
        ...
        <div className="mt-5 rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.62)] p-4">
        ...
        <div className="mt-5 flex items-center justify-between gap-4 rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.62)] px-4 py-4">
          ...
          <Link
            ...
            className="shrink-0 rounded-full border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.76)] px-3 py-2 text-xs font-semibold text-foreground/95 transition-colors hover:bg-[hsl(var(--mk-surface-muted)/0.72)]"
          >
            FAQ
          </Link>
        </div>
...
function DealCard({
  ...
  return (
    <div className="group rounded-2xl border border-[hsl(var(--mk-border)/0.4)] bg-[linear-gradient(155deg,hsl(var(--mk-surface)/0.9),hsl(var(--mk-surface-muted)/0.66))] p-4 transition-all hover:-translate-y-0.5 hover:border-primary/25">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h3 className="mt-3 text-lg font-semibold text-foreground/95">{deal.firmName}</h3>
        ...
        <div className="rounded-xl border border-primary/30 bg-primary/10 px-3 py-2 text-right">
          ...
          <p className="mt-1 text-xl font-semibold text-foreground/95">{deal.discountPercent}%</p>
        </div>
      </div>
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface)/0.78)] px-4 py-2 text-sm font-medium text-foreground/95 transition-colors hover:bg-[hsl(var(--mk-surface-muted)/0.72)]"
        >
...
function StatCard({
  ...
  return (
    <div className="rounded-2xl bg-[hsl(var(--mk-surface-muted)/0.72)] p-4 shadow-[0_16px_30px_-24px_hsl(var(--foreground)/0.85)]">
...
function StatPill({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.72)] p-3">
      <p className="text-[10px] uppercase tracking-[0.14em] text-muted-foreground">{label}</p>
      <p className="mt-1 text-sm font-semibold text-foreground/95">{value}</p>
    </div>
  )
}
...
function RadarRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between rounded-xl border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.66)] px-3 py-3">
      <span className="text-sm text-muted-foreground">{label}</span>
      <span className="text-sm font-medium text-foreground/95">{value}</span>
    </div>
  )
}
...
function InsightCard({
  ...
  return (
    <div className="rounded-2xl bg-[hsl(var(--mk-surface)/0.84)] p-5 shadow-[0_20px_44px_-34px_hsl(var(--foreground)/0.92)]">
...
function SelectLike<T extends string>({
  ...
  return (
    <select
      ...
      className="h-11 rounded-full border border-[hsl(var(--mk-border)/0.38)] bg-[hsl(var(--mk-surface-muted)/0.7)] px-4 text-sm text-foreground/95 outline-none transition-colors focus:border-primary/35"
    >
      {options.map((option) => (
