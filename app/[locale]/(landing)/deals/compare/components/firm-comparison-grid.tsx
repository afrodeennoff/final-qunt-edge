    ...
    <section className="qe-soft-panel mt-6 rounded-2xl p-4 sm:p-6">
      ...
      <div className="mt-5 hidden overflow-x-auto lg:block">
        <table className="w-full min-w-[880px] border-collapse text-left text-sm">
          ...
          <tbody>
            {firms.map((firm) => (
              <tr key={firm.id} className="border-b border-border transition-colors hover:bg-muted/30 last:border-b-0">
                <td className="sticky left-0 bg-muted/20 px-3 py-4 font-semibold text-foreground">{firm.name}</td>
