    ...
    <section className="qe-soft-panel mt-6 rounded-2xl p-4 sm:p-6">
      ...
      <div className="mt-5 hidden overflow-x-auto lg:block">
        <table className="w-full min-w-[880px] border-collapse text-left text-sm">
          <thead>
            <tr className="border-b border-[oklch(0.65_0.22_260/0.05)] text-xs uppercase tracking-[0.1em] text-muted-foreground">
          ...
          <tbody>
            {firms.map((firm) => (
              <tr key={firm.id} className="border-b border-[oklch(0.65_0.22_260/0.03)] transition-colors hover:bg-[oklch(0.65_0.22_260/0.05)] last:border-b-0">
                <td className="sticky left-0 bg-[oklch(0.65_0.22_260/0.03)] px-3 py-4 font-semibold text-foreground">{firm.name}</td>
