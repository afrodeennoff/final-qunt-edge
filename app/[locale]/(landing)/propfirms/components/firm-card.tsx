    ...
    <Link href={`/${locale}/firm/${slug}`} className="block group">
      <article className="relative overflow-hidden rounded-xl border border-border bg-muted/30 transition-[transform,opacity,background-color,border-color,box-shadow] duration-300 hover:-translate-y-1 hover:border-border hover:bg-muted/20">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1.5">
                <Badge variant="outline" className="rounded-full border-border bg-muted/30 text-[10px] font-medium tracking-wide text-muted-foreground">
        ...
        <div className="space-y-3 p-4">
          ...
          {/* Progress bar */}
          <div className="h-1 overflow-hidden rounded-full bg-muted/10">
            <div
        ...
        <div className="px-5 pb-4">
          <span className="inline-flex h-9 w-full items-center justify-center rounded-full border border-border text-xs font-medium text-muted-foreground transition-[background-color,border-color,color] duration-200 group-hover:border-border group-hover:bg-muted/10 group-hover:text-foreground">
            View Details
