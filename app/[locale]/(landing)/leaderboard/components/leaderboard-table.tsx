...
export function LeaderboardTableSkeleton() {
  return (
    <section className="overflow-hidden rounded-[1.9rem] border border-border/60 bg-[linear-gradient(160deg,hsl(var(--card)/0.62),hsl(var(--background)/0.48))] shadow-[0_24px_90px_-70px_rgba(0,0,0,0.95)]">
    ...
    <section className="overflow-hidden rounded-[1.9rem] border border-border/60 bg-[linear-gradient(160deg,hsl(var(--card)/0.62),hsl(var(--background)/0.48))] shadow-[0_24px_90px_-70px_rgba(0,0,0,0.95)]">
      ...
      {entries.length === 0 ? (
        <div className="px-5 py-10 sm:px-6">
          <div className="rounded-[1.4rem] border border-dashed border-border/60 bg-background/65 p-8 text-center text-sm text-muted-foreground">
