    ...
    return (
        <UnifiedPageShell widthClassName="max-w-[1280px]" className="py-8">
            ...
            <UnifiedSurface className="mt-6 text-center">
                ...
                <a
                    href={`/${locale}/support`}
                    className="inline-flex items-center justify-center rounded-full border border-border bg-muted/20 px-8 py-3 text-xs font-bold uppercase tracking-widest text-foreground transition-colors hover:bg-muted/20 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[hsl(var(--primary))] focus-visible:ring-offset-0"
                >
                    Contact Support
                </a>
            </UnifiedSurface>
