    ...
    <UnifiedPageShell widthClassName="max-w-[1280px]" className="py-8">
      ...
      <UnifiedSurface className="space-y-10">
        <section className="space-y-5">
          <p className="inline-flex rounded-full border border-border/26 bg-card/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href={`/${locale}/deals`} className="rounded-full border border-border/26 bg-card px-5 py-3 text-sm font-semibold text-foreground">
              Explore Deals
            </Link>
            <Link href={`/${locale}/propfirms`} className="rounded-full border border-border/26 bg-card px-5 py-3 text-sm font-semibold text-foreground">
              Compare Prop Firms
            </Link>
          </div>
        </section>
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="rounded-2xl border border-border/24 bg-card/50 p-5">
        ...
        <section className="rounded-2xl border border-border/24 bg-card/50 p-5">
          <h2 className="text-2xl font-semibold text-foreground">Feature Evidence From Existing Product Capabilities</h2>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <article className="rounded-xl border border-border/24 bg-card p-4">
              <h3 className="font-semibold text-foreground">Execution Review</h3>
            ...
            <article className="rounded-xl border border-border/24 bg-card p-4">
              <h3 className="font-semibold text-foreground">Prop-Firm Research Flow</h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Public deals and prop-firm pages connect journal decisions to challenge cost and rule context.
              </p>
            </article>
            <article className="rounded-xl border border-border/24 bg-card p-4">
              <h3 className="font-semibold text-foreground">Team Workflows</h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
        ...
        <section className="rounded-2xl border border-border/24 bg-card/50 p-5">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            <div className="rounded-xl border border-border/24 bg-card p-4">
              <p className="text-xs uppercase tracking-[0.12em] text-muted-foreground">Tracked Firms</p>
              <p className="mt-2 text-2xl font-semibold text-foreground">{overview?.totalTrackedFirms ?? "—"}</p>
            </div>
            <div className="rounded-xl border border-border/24 bg-card p-4">
              <p className="text-xs uppercase tracking-[0.12em] text-muted-foreground">Live Deals</p>
              <p className="mt-2 text-2xl font-semibold text-foreground">{overview?.totalLiveDeals ?? "—"}</p>
            </div>
            <div className="rounded-xl border border-border/24 bg-card p-4">
        ...
        <section className="rounded-2xl border border-border/24 bg-card/50 p-5">
          ...
          <div className="mt-4 space-y-3">
            {FAQ_ITEMS.map((item) => (
              <article key={item.question} className="rounded-xl border border-border/24 bg-card p-4">
        ...
        <section className="rounded-2xl border border-border/24 bg-card/60 p-5 text-center">
