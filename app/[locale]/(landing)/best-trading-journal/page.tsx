    ...
    <UnifiedPageShell widthClassName="max-w-[1280px]" className="py-8">
      ...
      <UnifiedSurface className="space-y-10">
        <section className="space-y-5">
          <p className="inline-flex rounded-full border border-border/60 bg-card/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href={`/${locale}/deals`} className="rounded-full border border-border/60 bg-card px-5 py-3 text-sm font-semibold text-foreground">
              Explore Deals
            </Link>
            <Link href={`/${locale}/propfirms`} className="rounded-full border border-border/60 bg-card px-5 py-3 text-sm font-semibold text-foreground">
              Compare Prop Firms
            </Link>
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-border/60 bg-card/50 p-5">
          ...
          <div className="mt-4 space-y-3">
            {FAQ_ITEMS.map((item) => (
              <article key={item.question} className="rounded-xl border border-border/60 bg-card p-4">
