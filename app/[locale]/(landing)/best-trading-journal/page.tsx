    ...
    <UnifiedPageShell widthClassName="max-w-[1280px]" className="py-8">
      ...
      <UnifiedSurface className="space-y-10">
        <section className="space-y-5">
          <p className="inline-flex rounded-full border border-[oklch(0.65_0.22_260/0.07)] bg-[oklch(0.65_0.22_260/0.03)] px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href={`/${locale}/deals`} className="rounded-full border border-[oklch(0.65_0.22_260/0.07)] bg-[oklch(0.65_0.22_260/0.03)] px-5 py-3 text-sm font-semibold text-foreground">
              Explore Deals
            </Link>
            <Link href={`/${locale}/propfirms`} className="rounded-full border border-[oklch(0.65_0.22_260/0.07)] bg-[oklch(0.65_0.22_260/0.03)] px-5 py-3 text-sm font-semibold text-foreground">
              Compare Prop Firms
            </Link>
          </div>
        </section>
