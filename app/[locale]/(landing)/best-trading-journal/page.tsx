      ...
      <UnifiedSurface className="space-y-10">
        <section className="space-y-5">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href={`/${locale}/deals`} className="rounded-full border border-border/26 bg-white/[0.02] px-5 py-3 text-sm font-semibold text-foreground/95">
              Explore Deals
            </Link>
            <Link href={`/${locale}/propfirms`} className="rounded-full border border-border/26 bg-white/[0.02] px-5 py-3 text-sm font-semibold text-foreground/95">
              Compare Prop Firms
            </Link>
          </div>
        </section>
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="rounded-xl border border-white/[0.06] bg-white/[0.050] p-5">
        ...
        <section className="rounded-xl border border-white/[0.06] bg-white/[0.050] p-5">
        ...
        <section className="rounded-xl border border-white/[0.06] bg-white/[0.050] p-5">
          ...
          <div className="mt-4 space-y-3">
            {FAQ_ITEMS.map((item) => (
              <article key={item.question} className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
        ...
        <section className="rounded-xl border border-white/[0.06] bg-white/[0.060] p-5 text-center">
