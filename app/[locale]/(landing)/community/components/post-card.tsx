...
const typeColors: Record<PostType, string> = {
  ...
  [PostType.DISCUSSION]: 'border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.06)] text-secondary-foreground',
}

const statusColors: Record<PostStatus, string> = {
  [PostStatus.OPEN]: 'border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.06)] text-secondary-foreground',
  ...
  [PostStatus.CLOSED]: 'border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.045)] text-muted-foreground',
}
