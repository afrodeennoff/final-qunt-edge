  ...
  return (
    <div className="w-full py-12 px-4 sm:px-6 sm:py-16 lg:px-8">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div className="p-6 rounded-xl bg-background/0.11 border border-border/30 hover:border-border/36 transition-colors group">
      ...
      <footer className="mt-24 pt-8 border-t border-border/30 text-center">
