...
=======
                <div className="p-6 rounded-2xl bg-card/70 border border-border/24 hover:border-border/36 transition-colors group">
...
=======
            <footer className="mt-24 pt-8 border-t border-border/24 text-center">
