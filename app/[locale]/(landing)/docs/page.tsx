...
export default function DocsOverviewPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="qe-home-ref space-y-12 text-[var(--qe-ref-text)]">
      ...
      {/* WHAT YOU CAN DO — 9 RICH FEATURE CARDS */}
      <div>
          ...
          <div className={cardMain}>
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 text-[11px] text-[var(--qe-ref-green)]">
                  <Link href={`/${locale}/propfirms`}>Browse the Prop Firms Catalogue →</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={cardMain}>
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 text-[11px] text-[var(--qe-ref-green)]">
                  <Link href={`/${locale}/teams`}>Learn about Teams →</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={cardMain}>
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 text-[11px] text-[var(--qe-ref-green)]">
                  <Link href={`/${locale}/leaderboard`}>View the Leaderboard →</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={cardMain}>
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 text-[11px] text-[var(--qe-ref-green)]">
                  <Link href={`/${locale}/deals`}>Shop current deals →</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* GETTING STARTED SECTION — CLEAR CARDS */}
      <div>
      ...
      {/* PROFESSIONAL MANUAL FEEL — DEEPER OVERVIEW */}
      <div className={cardMain}>
      ...
      {/* FAQ ACCORDION — EXACT HOMEPAGE STYLE */}
      <div>
