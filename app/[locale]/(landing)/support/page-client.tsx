    ...
    <UnifiedPageShell widthClassName="max-w-[1280px]" className="py-8">
      <UnifiedSurface className="flex h-[calc(100vh-220px)] min-h-[680px] flex-col">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mb-6 block cursor-pointer rounded-xl border border-white/[0.08] bg-white/[0.070] p-4 transition-colors duration-150 hover:border-border/36 hover:bg-white/[0.02] group"
        >
