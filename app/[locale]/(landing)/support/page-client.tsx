    ...
    <UnifiedPageShell widthClassName="max-w-[1280px]" className="py-8">
      <UnifiedSurface className="flex h-[calc(100vh-220px)] min-h-[680px] flex-col">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mb-6 block cursor-pointer rounded-xl border border-border/0.06 bg-background/0.11 p-4 transition-colors duration-150 hover:border-border/36 hover:bg-[oklch(0.65_0.22_260/0.03)] group"
        >
