  ...
  return (
    <footer aria-labelledby="footer-heading" className="relative mt-6 px-4 pb-8 sm:px-6 sm:pb-10">
      ...
      <motion.div
        ...
        className="mx-auto w-full max-w-[1240px] rounded-[30px] border border-border/60 bg-card/80 p-6 shadow-[0_28px_60px_-40px_hsl(var(--brand-ink)/0.8)] sm:p-8 lg:p-10"
      >
