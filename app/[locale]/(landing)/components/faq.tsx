...
export default function FAQ() {
 ...
 <div className="mx-6 overflow-hidden rounded-[2.2rem] border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.038_0_0)] p-6 shadow-[0_0_0_0.5px_rgba(255,255,255,0.05),0_28px_70px_-42px_rgba(0,0,0,0.96)]">
