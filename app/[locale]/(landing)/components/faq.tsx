      ...
      <div className="mx-6 overflow-hidden rounded-2xl border border-[oklch(0.65_0.22_260_/_0.07)] bg-[linear-gradient(180deg,oklch(0.064_0.011_260_/_0.88)_0%,oklch(0.052_0.009_260_/_0.82)_100%)] p-6 shadow-[inset_0_1px_0_oklch(0.65_0.22_260_/_0.05),0_28px_70px_-42px_rgba(0,0,0,0.96)]">
        <div className="container mx-auto px-4">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)]">
            <div className="rounded-xl border border-[oklch(0.65_0.22_260_/_0.07)] bg-[oklch(0.052_0.009_260_/_0.68)] p-6">
            ...
            <div className="rounded-xl border border-[oklch(0.65_0.22_260_/_0.06)] bg-[oklch(0.05_0.009_260_/_0.6)] p-5">
              <div className="space-y-4">
                <details className="rounded-xl border border-[oklch(0.65_0.22_260_/_0.07)] bg-[oklch(0.052_0.009_260_/_0.68)] p-4">
