      ...
      <div className="mx-6 overflow-hidden rounded-2xl border frost-border-7 frost-gradient-card p-6 shadow-[inset_0_1px_0_rgba(0,0,0,0.03),0_28px_70px_-42px_rgba(0,0,0,0.96)]">
        <div className="container mx-auto px-4">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)]">
            <div className="rounded-xl border frost-border-7 bg-[var(--card)] p-6">
            ...
            <div className="rounded-xl border border-[rgba(0,0,0,0.03)] frost-bg-dim p-5">
              <div className="space-y-4">
                <details className="rounded-xl border frost-border-7 bg-[var(--card)] p-4">
