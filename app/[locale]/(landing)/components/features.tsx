			...
			<div className="relative h-full">
				...
				<CardContent>
					<div className="flex flex-col gap-3 sm:gap-4">
						...
						<div
							className={cn("relative flex w-full items-center justify-center overflow-hidden rounded-xl","border border-[oklch(0.65_0.22_260/0.08)] bg-background/25","group-hover:border-[oklch(0.65_0.22_260/0.09)] group-hover:bg-[oklch(0.65_0.22_260/0.035)] transition-[transform,opacity,background-color,border-color,box-shadow] duration-500",
				...
				<div className="grid gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
					...
					<div className="grid grid-cols-2 gap-3 sm:gap-4">
						{features.map((feature, index) => (
							...
							>
								<div className="mb-4 flex size-8 items-center justify-center rounded-lg border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.03)]">
									{feature.icon}
								</div>
