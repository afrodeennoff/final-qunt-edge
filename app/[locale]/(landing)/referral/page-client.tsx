...
export default function ReferralPage() {
  ...
  const requirements = [
    {
      ...
      icon: <CheckCircle2 className="w-5 h-5 text-foreground/95" />,
    },
    {
  ...
  return (
    <div className="px-4 py-12 bg-background text-foreground/95">
      <div className="w-full">
        <Card className="mb-8 border-[oklch(0.65_0.22_260/0.08)] bg-gradient-to-br from-card/85 via-card/70 to-card/85 text-foreground/95 shadow-2xl">
          <CardContent className="p-6 md:p-10">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="space-y-4">
                <Badge className="w-fit bg-white/[0.025] text-foreground/95 hover:bg-white/[0.035]">
        ...
        <Card className="mb-8 bg-[oklch(0.65_0.22_260/0.03)] border-[oklch(0.65_0.22_260/0.08)]">
          <CardHeader>
          ...
          <CardContent>
            ...
            <div className="space-y-4">
              {requirements.map((req, index) => (
                <div key={index} className="flex gap-4 p-4 rounded-lg border border-[oklch(0.65_0.22_260/0.08)] bg-muted/30">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {tiers.map((tier, index) => (
                <div
                  key={index}
                  className="p-6 rounded-lg border border-[oklch(0.65_0.22_260/0.08)] bg-muted/20 flex flex-col items-center text-center transition-colors hover:bg-muted/35"
                >
        ...
        {/* Important Notes */}
        <Card className="bg-[oklch(0.65_0.22_260/0.03)] border-[oklch(0.65_0.22_260/0.08)]">
          <CardHeader>
