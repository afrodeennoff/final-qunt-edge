...
export default async function NewBlogPostPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="rounded-2xl border border-white/[0.6] bg-white/[0.070] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)] backdrop-blur-sm">
