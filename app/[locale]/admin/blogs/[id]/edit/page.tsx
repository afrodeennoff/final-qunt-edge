...
export default async function EditBlogPostPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="rounded-2xl border border-border/30 bg-[oklch(0.65_0.22_260/0.05)] p-6 shadow-[inset_0_1px_0_oklch(0.65_0.22_260/0.06),0_4px_16px_-4px_rgba(0,0,0,0.3)]">
        <BlogForm
          post={{
            id: post.id,
            title: post.title,
