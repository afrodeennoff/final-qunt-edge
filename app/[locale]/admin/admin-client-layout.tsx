  ...
  return (
    ...
    >
      ...
      <SidebarInset className="qe-v2-app-shell relative overflow-hidden">
        <div className="pointer-events-none absolute inset-x-6 top-0 z-0 h-32 rounded-b-2xl border border-border/30 bg-primary/[0.02]" />
        <header
              ...
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                  <div className="flex items-center gap-2.5">
                    <span className="hidden rounded-full border border-border/30 bg-background/40 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-muted-foreground sm:inline-flex">
                      Admin
                    </span>
