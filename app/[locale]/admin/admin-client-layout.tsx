      ...
      <SidebarInset className="qe-v2-app-shell relative overflow-hidden">
        ...
        >
          <div className="mx-auto flex w-full max-w-[1800px] items-center">
            <div className={cn(unifiedSectionPanelClassName, 'relative flex min-h-[4.5rem] w-full flex-col gap-4 overflow-hidden rounded-[2rem] px-3 py-3 sm:px-4 lg:flex-row lg:items-center lg:justify-between')}>
              <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
              <div className="flex min-w-0 items-center gap-3">
                <SidebarTrigger className="h-10 w-10 rounded-[1rem] border border-primary/12 bg-primary/[0.05] text-foreground/64 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition-[opacity,background-color,border-color,color] duration-200 hover:border-primary/20 hover:bg-primary/10 hover:text-foreground/95 md:h-9 md:w-9" />
