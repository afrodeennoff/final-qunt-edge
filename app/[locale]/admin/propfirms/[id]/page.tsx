        ...
        {firm.reviews.length === 0 ? (
          ...
          <div className="space-y-3">
            {firm.reviews.map((review) => (
              <div
                key={review.id}
                className="rounded-lg border border-[oklch(0.65_0.22_260/0.08)] p-4"
              >
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 border-t border-[oklch(0.65_0.22_260/0.08)] pt-3">
                    <p className="text-xs text-muted-foreground">
      ...
      <CardContent className="space-y-6">
        {canManageCoupons ? (
          <form
            ...
            className="space-y-4 rounded-xl border border-[oklch(0.65_0.22_260/0.08)] p-4"
          >
            <input type="hidden" name="propFirmId" value={firm.id} />
            <input type="hidden" name="locale" value={locale} />
            <div className="space-y-2">
...
function CouponEditorCard({
  ...
  return (
    <div className="rounded-xl border border-[oklch(0.65_0.22_260/0.08)] p-4">
      <div className="flex flex-col gap-4 border-b border-[oklch(0.65_0.22_260/0.08)] pb-4 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          <div className="flex flex-wrap items-center gap-2">
      ...
      <div className="mt-4 flex flex-col gap-3 border-t border-[oklch(0.65_0.22_260/0.08)] pt-4 md:flex-row md:items-center md:justify-between">
