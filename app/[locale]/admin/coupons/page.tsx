...
function CouponEditCard({
  ...
  return (
    <Card variant="flat" hover className="overflow-hidden">
      <CardHeader size="sm" className="space-y-3 border-b border-white/[0.6]">
      ...
      <CardContent size="sm" className="space-y-4 pt-4">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-white/[0.6] pt-4">
...
export default async function AdminCouponsPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card variant="flat" hover>
        <CardHeader className="space-y-2 border-b border-white/[0.6]">
          <div className="flex items-center justify-between gap-3">
            <div className="space-y-1">
