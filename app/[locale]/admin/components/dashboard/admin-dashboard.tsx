...
export function AdminDashboard() {
    ...
    return (
      <div className="p-6">
        <div className="animate-pulse space-y-4">
          <div className="h-8 w-1/4 rounded bg-white/[0.03]"></div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="h-32 rounded bg-white/[0.03]"></div>
            <div className="h-32 rounded bg-white/[0.03]"></div>
            <div className="h-32 rounded bg-white/[0.03]"></div>
          </div>
          <div className="h-80 rounded bg-white/[0.03]"></div>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      <Card className="border-white/[0.08] bg-white/[0.080] p-6 shadow-[0_20px_36px_-30px_hsl(var(--foreground)/0.45)]">
          ...
          {[
            ...
            return (
              <Link
                key={item.label}
                href={item.href}
                className="group rounded-xl border border-white/[0.08] bg-background/60 p-4 transition-all hover:-translate-y-0.5 hover:border-border/30 hover:bg-background hover:shadow-[0_18px_30px_-24px_hsl(var(--foreground)/0.45)]"
              >
                <div className="flex items-start gap-3">
                  <div className="rounded-lg border border-white/[0.06] bg-muted/60 p-2 text-foreground/95 transition-colors group-hover:bg-foreground group-hover:text-background">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border-white/[0.08] bg-white/[0.080] p-5 shadow-[0_20px_36px_-30px_hsl(var(--foreground)/0.45)]">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="border border-white/[0.08] bg-white/[0.070] p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)]">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="space-y-2 border-white/[0.08] bg-white/[0.080] p-6 shadow-[0_20px_36px_-30px_hsl(var(--foreground)/0.45)]">
