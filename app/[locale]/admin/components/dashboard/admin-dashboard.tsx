	...
	return (
		<div className="space-y-6 p-4 sm:p-6">
					...
					{[
						...
						return (
							<Link
								key={item.label}
								href={item.href}
								className={cn(unifiedInsetPanelClassName, 'group p-4 transition-[opacity,background-color,border-color,transform,box-shadow] hover:-translate-y-0.5 hover:border-primary/18 hover:bg-muted/40 hover:shadow-[0_18px_30px_-24px_hsl(var(--foreground)/0.45)]')}
							>
								<div className="flex items-start gap-3">
									<div className="rounded-lg border-0 bg-muted p-2 text-foreground transition-colors group-hover:bg-foreground group-hover:text-background">
			...
			<Tabs defaultValue="overview" className="w-full">
				<TabsList className="border-0 bg-muted p-1 shadow-[inset_0_1px_0_hsl(var(--primary)/0.06),0_4px_16px_-4px_rgba(0,0,0,0.3)]">
				...
				<TabsContent value="overview" className="space-y-6">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<Card className="space-y-2 border-transparent bg-card p-6 shadow-[0_4px_12px_-6px_rgba(0,0,0,0.5)]">
				...
				<TabsContent value="users">
					<Card className="border-transparent bg-card p-6 shadow-[0_4px_12px_-6px_rgba(0,0,0,0.5)]">
