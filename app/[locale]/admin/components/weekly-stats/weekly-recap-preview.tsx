              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    />
                    {isOpen && (
                      <CommandList className="absolute top-full left-0 right-0 z-50 mt-1 max-h-[300px] overflow-auto rounded-md border bg-white/[0.04] shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_8px_32px_-8px_rgba(0,0,0,0.4)]">
