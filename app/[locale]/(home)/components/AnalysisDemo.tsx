  ...
  return (
    <section className="relative overflow-hidden px-4 py-16 sm:px-6 md:py-20 lg:px-8 xl:py-24">
      ...
      >
        ...
        <div className="overflow-hidden rounded-lg border-border/60 bg-card/80 shadow-sm">
          <div className="grid lg:grid-cols-[minmax(0,1.25fr)_minmax(280px,0.75fr)]">
            <div className="border-b border-border/60 p-5 md:p-6 lg:border-b-0 lg:border-r lg:border-border/60">
              ...
              <div
                className={cn(
                  'overflow-hidden rounded-md border-border/60 bg-background/70 p-3',
            ...
            <div className="flex flex-col gap-4 p-5 md:p-6">
              ...
              <div
                className={cn(
                  'rounded-md border-border/60 bg-background/70 p-4',
                  isMobile ? 'min-h-0' : 'min-h-[224px]',
                )}
              >
                <p className="text-sm leading-relaxed text-foreground/80">{activeLog}</p>
              </div>
              ...
              <div className="rounded-md border-border/60 bg-background/70 p-4">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-muted-foreground">
...
function MetricCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border-border/60 bg-background/70 p-4 transition-[transform,box-shadow,border-color] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:border-border/80 hover:shadow-md">
