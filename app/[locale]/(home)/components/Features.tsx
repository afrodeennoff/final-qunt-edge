            ...
            return (
              ...
              >
                <div className="mb-4">
                  ...
                  >
                    <Icon
                      className={`w-4.5 h-4.5 ${feature.highlight ? 'text-primary' : 'text-muted-foreground/70'}`}
                    />
                  </div>
                </div>
                <h3 className="text-[1.02rem] font-semibold text-foreground mb-2 tracking-[-0.01em] [font-family:var(--home-display)]">
                  {feature.title}
                </h3>
                <p className="text-[0.88rem] text-muted-foreground/70 leading-relaxed">
                  {feature.description}
                </p>
              </motion.div>
            )
