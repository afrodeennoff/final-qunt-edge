            ...
            {features.map((feature) => {
              ...
              return (
                <MotionStaggerItem key={String(feature.title)} className={feature.colSpan}>
                  <Card variant="glass" className="flex h-full flex-col gap-4 p-5">
                    ...
                    <span className="inline-flex w-fit items-center rounded-full border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.02)] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-muted-foreground">
