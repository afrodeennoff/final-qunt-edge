...
export default function ProblemStatement() {
  return (
    <section id="problem" className="relative border-y border-[hsl(var(--foreground)/0.2)] px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-7 lg:grid-cols-[1fr_1.1fr] lg:items-start">
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-[hsl(var(--mk-text-muted)/0.95)] [font-family:var(--home-copy)]">The Gap</p>
            ...
            <p className="mt-4 max-w-xl text-[15px] leading-[1.75] text-[hsl(var(--mk-text-muted)/0.96)] [font-family:var(--home-copy)]">
            ...
            <div className="mt-6 rounded-2xl border border-[hsl(var(--brand-primary)/0.3)] bg-[hsl(var(--brand-primary)/0.08)] p-4">
              ...
              <p className="mt-1 text-sm text-[hsl(var(--mk-text-muted)/0.95)] [font-family:var(--home-copy)]">
             ...
             {problems.map((item) => {
               ...
               return (
                 ...
                 >
                   ...
                   <p className="mt-2 text-sm leading-relaxed text-[hsl(var(--mk-text-muted)/0.95)] [font-family:var(--home-copy)]">{item.desc}</p>
                 </article>
               )
             })}
           </div>
