  ...
  return (
    <section id="faq" className="px-4 py-8 sm:py-12 lg:py-16 md:px-6 lg:px-8">
      <div className="mx-auto grid max-w-[1360px] gap-6 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] lg:gap-8">
        <motion.div
          className="rounded-lg border-0 bg-card/80 p-6 shadow-[0_1px_2px_rgba(0,0,0,0.12),0_4px_12px_rgba(0,0,0,0.28),0_20px_48px_-8px_rgba(0,0,0,0.85)] lg:sticky lg:top-28"
          initial={false}
        ...
        >
          ...
          <div className="mt-8 rounded-md border-0 bg-background/70 p-5">
        ...
        <motion.div
          className="rounded-lg border-0 bg-card/70 p-4 shadow-[0_1px_2px_rgba(0,0,0,0.12),0_4px_12px_rgba(0,0,0,0.28),0_20px_48px_-8px_rgba(0,0,0,0.85)] sm:p-5"
          initial={false}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.45 }}
