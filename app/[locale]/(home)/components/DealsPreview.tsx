      ...
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {topDeals.map((deal) => (
            <div
              key={deal.id}
              className="group relative overflow-hidden rounded-2xl bg-card border border-border/10 p-6 transition-all duration-300 hover:border-primary/25 hover:shadow-[0_0_35px_-18px] hover:shadow-primary/15"
            >
