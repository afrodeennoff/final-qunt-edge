...
const fallbackDeals: DealPreview[] = [
  { id: '1', firmName: 'TopStep', discountPercent: 30, couponCode: 'EDGE30', expiryDate: '2026-04-15', category: 'Futures' },
  { id: '2', firmName: 'Apex Trader', discountPercent: 25, couponCode: 'APEX25', expiryDate: '2026-04-20', category: 'Futures' },
  { id: '3', firmName: 'Earn2Trade', discountPercent: 20, couponCode: 'E2T20', expiryDate: '2026-04-10', category: 'Futures' },
  { id: '4', firmName: 'Bulenox', discountPercent: 35, couponCode: 'BUL35', expiryDate: '2026-04-25', category: 'Futures' },
]
...
export default function DealsPreview({ locale, deals }: DealsPreviewProps) {
  const displayDeals = deals && deals.length > 0 ? deals.slice(0, 4) : fallbackDeals
