  ...
  return (
    <section className="px-4 py-16 sm:px-6 md:py-20 lg:px-8 xl:py-24">
      <div className="mx-auto max-w-[1360px]">
        ...
        >
          <div className="rounded-lg border border-border/50 bg-card/80 p-6 shadow-sm md:p-8">
            <Badge
              variant="outline"
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.article
                  ...
                  className="rounded-lg border border-border/50 bg-card/70 p-5 shadow-sm"
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-md border border-border/50 bg-background/70 text-primary">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
          <div>
            <div className="mb-4 rounded-lg border border-border/50 bg-background/70 p-5 shadow-sm">
            ...
            <div className="grid gap-4">
              {testimonials.map((testimonial, index) => (
                <motion.article
                  ...
                  className="flex h-full flex-col rounded-lg border border-border/50 bg-card/70 p-6 shadow-sm"
                ...
                >
                  <div className="mb-4 inline-flex w-fit rounded-full border border-border/50 bg-background/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-muted-foreground">
                    {t('landing.home.social.traderVoice')}
                  </div>
                  <MessageSquare className="mb-4 h-5 w-5 text-primary/60" />
                  <blockquote className="mb-6 text-sm leading-8 text-foreground/80">
                    &ldquo;{testimonial.quote}&rdquo;
                  </blockquote>
                  <div className="mt-auto flex items-center gap-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-md border border-border/50 bg-background/70 text-sm font-semibold text-primary">
