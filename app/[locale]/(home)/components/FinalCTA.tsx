...
export function FinalCTA() {
  return (
    <section className="animate-fade-in-up relative border-t-0 py-28 overflow-hidden">
      ...
      <div className="animate-stagger relative mx-auto max-w-3xl px-6 text-center">
        <div className="animate-fade-in-up mx-auto mb-5 inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-gradient-to-r from-primary/[0.08] to-primary/[0.03] px-4 py-1.5 text-[10px] font-mono tracking-[2.5px] text-primary shadow-sm">
          <Sparkles className="h-3 w-3" />
          START TODAY
        </div>

        <h2 className="animate-fade-in-up text-balance text-5xl font-light tracking-[-0.025em] sm:text-6xl text-foreground/90">
          Your edge deserves<br />better tools.
        </h2>

        <p className="animate-fade-in-up mx-auto mt-6 max-w-md text-[14px] text-muted-foreground/70 leading-relaxed">
