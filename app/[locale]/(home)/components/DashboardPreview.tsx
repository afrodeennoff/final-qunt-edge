...
export default function DashboardPreview() {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.08] bg-[oklch(0.028_0.004_264/0.94)] shadow-[0_0_0_0.5px_rgba(180,210,255,0.08),0_30px_90px_-40px_rgba(0,0,0,0.95),0_0_90px_-24px_oklch(0.65_0.22_260/0.18)] backdrop-blur-xl">
