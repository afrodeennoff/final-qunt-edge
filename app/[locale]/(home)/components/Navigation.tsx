...
export default function Navigation({ locale }: NavigationProps) {
 ...
 <div className="hidden rounded-full border border-border/0.04 bg-background/0.04 p-1 md:flex md:items-center md:gap-1">
 {navLinks.map((link) => (
 <Link
 key={link.href}
 href={link.href}
 ...
 <Button variant="outline" size="lg" className="w-full rounded-full border-border/0.08 bg-background/30">
 Login
 </Button>
