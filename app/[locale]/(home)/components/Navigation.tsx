...
<<<<<<< HEAD
 ...
 <div className="mx-auto flex h-[72px] w-full max-w-6xl items-center justify-between rounded-[2rem] border border-white/[0.08] bg-black/72 px-4 shadow-[0_0_0_0.5px_rgba(180,210,255,0.08),0_24px_70px_-40px_rgba(0,0,0,0.92)] backdrop-saturate-200 sm:px-5">
 <Link href={`/${locale}`} className="flex items-center gap-2.5 group">
 <div className="flex h-10 w-10 items-center justify-center rounded-[1.15rem] bg-gradient-to-br from-primary to-primary/70 text-primary-foreground shadow-[0_0_22px_hsl(var(--primary)/0.3)] transition-shadow duration-300 group-hover:shadow-[0_0_32px_hsl(var(--primary)/0.4)]">
