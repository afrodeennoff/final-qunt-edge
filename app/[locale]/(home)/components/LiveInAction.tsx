    ...
    <section className="py-24 border-t-0">
      ...
      <div className="group relative mx-auto mt-12 max-w-5xl overflow-hidden rounded-2xl border-0 bg-card/50 shadow-[inset_0_0_50px_-25px] shadow-primary/5">
        <div className="aspect-video w-full bg-gradient-to-b from-background via-background to-background/90 flex items-center justify-center relative">
          ...
          <div className="absolute bottom-5 right-5 rounded-full bg-background/60 px-3 py-1 text-[10px] font-mono tracking-[2px] text-white/50 backdrop-blur-sm">
        ...
        <DialogContent className="max-w-5xl p-0 overflow-hidden border-border/20 bg-background">
          ...
          <div className="relative aspect-video w-full bg-black">
            ...
            <button
              ...
              className="absolute right-4 top-4 z-50 rounded-full bg-background/60 p-2 text-white/80 hover:bg-background/80 hover:text-white backdrop-blur-sm transition-all"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
