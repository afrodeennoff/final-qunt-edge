...
export default function HomeContent({ locale }: { locale: string }) {
  return (
    <div className="relative overflow-x-hidden bg-[radial-gradient(1200px_480px_at_50%_-10%,hsl(var(--foreground)/0.09),transparent_68%),linear-gradient(180deg,hsl(var(--background))_0%,hsl(var(--card))_36%,hsl(var(--background))_100%)] selection:bg-[hsl(var(--primary)/0.3)] selection:text-primary-foreground [--home-display:var(--font-geist)] [--home-copy:var(--font-manrope)] [--home-mono:var(--font-geist)]">
