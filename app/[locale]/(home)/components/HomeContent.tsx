              ...
              <div className="mt-4 flex items-center justify-center py-6">
                <div className="relative h-36 w-full max-w-[200px]">
                  <svg viewBox="0 0 200 140" className="w-full h-full">
                    ...
                    <text x="100" y="33" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="11" fontWeight="700">Secure Data</text>

                    <rect x="20" y="65" width="56" height="30" rx="6" fill="rgba(0,255,159,0.06)" stroke="rgba(0,255,159,0.2)" strokeWidth="1" />
                    <text x="48" y="84" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Encrypted</text>

                    <rect x="124" y="65" width="56" height="30" rx="6" fill="rgba(0,255,159,0.06)" stroke="rgba(0,255,159,0.2)" strokeWidth="1" />
                    <text x="152" y="84" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Access Control</text>

                    <rect x="50" y="105" width="100" height="28" rx="6" fill="rgba(0,255,159,0.1)" stroke="rgba(0,255,159,0.3)" strokeWidth="1" />
                    <text x="100" y="123" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="11" fontWeight="700">Zero-Knowledge Vault</text>
               ...
               <div className="mt-4 flex items-center justify-center py-6">
                 <div className="relative h-36 w-full max-w-[200px]">
                   <svg viewBox="0 0 200 140" className="w-full h-full">
                     ...
                     <text x="60" y="40" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Backtested</text>
                     ...
                     <text x="140" y="40" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">High</text>
                     ...
                     <text x="60" y="109" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Low Draw</text>

                     <rect x="110" y="85" width="60" height="40" rx="6" fill="rgba(0,255,159,0.06)" stroke="rgba(0,255,159,0.2)" strokeWidth="1" />
                     <text x="140" y="109" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Fast Exec</text>
              ...
              <div className="mt-4 flex items-center justify-center py-6">
                <div className="relative h-36 w-full max-w-[200px]">
                  <svg viewBox="0 0 200 140" className="w-full h-full">
                    ...
                    <text x="50" y="39" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Open AI</text>

                    <circle cx="150" cy="35" r="18" fill="rgba(0,255,159,0.08)" stroke="rgba(0,255,159,0.25)" strokeWidth="1" />
                    <text x="150" y="39" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Audit Logs</text>

                    <rect x="25" y="75" width="50" height="34" rx="6" fill="rgba(0,255,159,0.06)" stroke="rgba(0,255,159,0.2)" strokeWidth="1" />
                    <text x="50" y="95" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Real-Time</text>

                    <rect x="125" y="75" width="50" height="34" rx="6" fill="rgba(0,255,159,0.06)" stroke="rgba(0,255,159,0.2)" strokeWidth="1" />
                    <text x="150" y="95" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="600">Reports</text>

                    <rect x="60" y="115" width="80" height="22" rx="4" fill="rgba(0,255,159,0.1)" stroke="rgba(0,255,159,0.3)" strokeWidth="1" />
                    <text x="100" y="130" textAnchor="middle" fill="var(--qe-ref-green)" fontSize="10" fontWeight="700">Full Visibility</text>
