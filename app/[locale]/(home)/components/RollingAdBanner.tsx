...
export default function RollingAdBanner() {
  ...
  return (
    <div className="relative w-full max-w-full overflow-hidden rounded-[14px] bg-gradient-to-r from-muted/30 via-muted/20 to-muted/30 border border-border/10 shadow-sm">
