...
export default async function RollingAdBanner() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-white/[0.080] backdrop-blur-sm">
        ...
        <div className="flex animate-scroll whitespace-nowrap py-2.5">
          {repeatedItems.map((item, idx) => (
            <Link
              ...
              className={cn(
                "inline-flex items-center gap-2.5 px-4 transition-opacity duration-300 hover:opacity-80",
