...
export default function FirmCard({ firm, locale }: FirmCardProps) {
  return (
    <Link
      ...
      className="group block rounded-2xl border border-[var(--frost-border)] bg-[var(--surface-card)] p-5 transition-all hover:-translate-y-0.5 hover:border-[var(--frost-border-strong)] hover:bg-[var(--surface-card)]"
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="rounded-2xl border border-[var(--frost-border)] bg-[oklch(0.06_0_0)] px-3 py-2 text-right">
          <p className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Reviews</p>
          <p className="mt-1 text-lg font-semibold text-foreground">{firm._count.reviews}</p>
        </div>
      </div>
