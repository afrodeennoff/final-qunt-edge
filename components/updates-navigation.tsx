      ...
      <div className="min-w-0">
        {next ? (
          <Link
            ...
            className="group flex flex-col gap-1.5 rounded-xl border-0 bg-[linear-gradient(180deg,var(--card)_0%,var(--card)_100%)] p-4 transition-[background-color,border-color,opacity] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-border/60 hover:bg-[linear-gradient(180deg,var(--card)_0%,var(--card)_100%)]"
          >
      ...
      <div className="min-w-0">
        {previous ? (
          <Link
            ...
            className="group flex flex-col items-end gap-1.5 rounded-xl border-0 bg-[linear-gradient(180deg,var(--card)_0%,var(--card)_100%)] p-4 transition-[background-color,border-color,opacity] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-border/60 hover:bg-[linear-gradient(180deg,var(--card)_0%,var(--card)_100%)]"
          >
            <span className="flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
              {t.older}
