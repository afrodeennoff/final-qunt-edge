...
export function GlobalMotionEffects() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[120]">
      <motion.div className="h-[2px] origin-left bg-foreground shadow-[0_0_18px_hsl(var(--foreground)/0.35)]" style={{ scaleX: progress }} />
      <motion.div className="h-px w-full bg-muted-foreground" style={{ opacity: glowOpacity }} />
    </div>
  )
}
