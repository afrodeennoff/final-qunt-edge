...
export const minimalPanelClassName =
  'rounded-lg border border-border/40 bg-card shadow-sm transition-[opacity,background-color,border-color] duration-[200ms] ease-out'
...
export const minimalCardClassName =
  'rounded-lg border border-border/40 bg-card shadow-sm transition-[opacity,background-color,border-color] duration-[200ms] ease-out hover:shadow-md hover:-translate-y-0.5'
...
export const minimalChipClassName =
  'inline-flex items-center gap-1 rounded-full border border-border/40 bg-muted/50 px-2.5 py-0.5 text-xs font-medium text-muted-foreground transition-[opacity,background-color,border-color] duration-[200ms] ease-out hover:bg-muted'

export const minimalToolbarClassName =
  'rounded-lg border border-border/40 bg-card/50 shadow-sm p-4'
