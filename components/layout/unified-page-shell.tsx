    ...
    <div
      className={cn(
        ...
        variant !== "minimal" && [
          ...
          "before:bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,oklch(0.7001_0.1882_313.2907/0.12),transparent)]",
  ...
  return (
    <section
      className={cn(
        ...
        variant === "glass" && [
          "border-v2-border/65 bg-[linear-gradient(180deg,oklch(0.6083_0.2172_297.1153/0.10),rgba(255,255,255,0.02))]",
