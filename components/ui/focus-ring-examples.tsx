...
export function FocusRingComponentExample() {
 ...
 <div className="border border-border/30 bg-[oklch(0.65_0.22_260/0.03)] p-4">
...
export function ReducedMotionExample() {
 ...
 <FocusRing>
 <div className="border border-border/30 bg-[oklch(0.65_0.22_260/0.03)] p-4 cursor-pointer">
