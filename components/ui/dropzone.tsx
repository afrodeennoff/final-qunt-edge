...
const Dropzone = ({
 ...
 {...getRootProps({
 className: cn(
 'border-2 border-transparent rounded-xl p-6 text-center bg-primary/[0.03] transition-colors duration-300 text-foreground',
 className,
...
const DropzoneContent = ({ className }: { className?: string }) => {
 ...
 <div className="h-10 w-10 rounded border overflow-hidden shrink-0 bg-background/25 flex items-center justify-center relative">
 <Image
 src={file.preview}
 alt={file.name}
 fill
 ...
 <div className="h-10 w-10 rounded border bg-background/25 flex items-center justify-center">
 <File size={18} />
 </div>
 )}
