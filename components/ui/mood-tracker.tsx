...
const COLOR_SCALE = ["bg-[hsl(var(--chart-8))]","bg-[hsl(var(--chart-7))]","bg-[hsl(var(--chart-6))]","bg-[hsl(var(--chart-5))]","bg-[hsl(var(--chart-4))]","bg-[hsl(var(--chart-3))]","bg-[hsl(var(--chart-2))]",
] as const

const Tracker = React.forwardRef<HTMLDivElement, TrackerProps>(
 (
 { data = [], defaultBackgroundColor ="bg-background/25", className, hoverEffect, onSelectionChange, valueIndex, ...props },
 forwardedRef,
 ) => {
