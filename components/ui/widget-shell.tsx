...
export function WidgetShell({
 ...
 className={cn("widget-enter-smooth relative overflow-hidden rounded-xl border border-white/[0.06] bg-white/[0.02]","shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]","transition-all duration-200 ease-[cubic-bezier(0.22,1,0.36,1)]","hover:border-white/[0.10] hover:bg-white/[0.03]","focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background","h-full",
