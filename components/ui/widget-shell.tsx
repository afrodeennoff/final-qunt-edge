  ...
  return (
    <CardV2
      ...
      className={cn(
        ...
        "hover:border-v2-border/38",
        "hover:bg-v2-bg-surface/94",
    ...
    >
      {(title || actions || icon || description) && (
        <CardV2Header className="border-b border-border/40 px-[var(--space-4)] py-[var(--space-3)] sm:px-[var(--space-4)] sm:py-[var(--space-3)]">
