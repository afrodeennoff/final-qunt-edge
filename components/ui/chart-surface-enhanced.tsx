...
export function ChartSurface({
 ...
 {hasHeader && (
 <div
 className={cn("flex shrink-0 items-center border-b border-border/30-subtle",
  isSmall ?"h-10 px-2" :"h-12 px-3",
 headerClassName
 )}
 >
 ...
 {hasFooter && (
 <div
 className={cn("flex shrink-0 items-center border-t border-border/30-subtle",
