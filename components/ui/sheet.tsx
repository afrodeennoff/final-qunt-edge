...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ...
    className={cn(
      "fixed inset-0 z-50 bg-[rgba(4,10,24,0.72)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
