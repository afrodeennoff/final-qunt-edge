...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ...
    className={cn('-mx-1 my-1 h-px bg-transparent/60', className)}
    {...props}
  />
))
