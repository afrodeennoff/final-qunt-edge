...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        'relative z-50 max-h-96 min-w-32 overflow-hidden rounded-[10px] border border-[oklch(0.65_0.22_260_/_0.07)] bg-[linear-gradient(180deg,oklch(0.062_0.01_260_/_0.72)_0%,oklch(0.05_0.009_260_/_0.68)_100%)] backdrop-blur-[20px] backdrop-saturate-[1.2] text-popover-foreground shadow-[inset_0_1px_0_oklch(0.65_0.22_260_/_0.05),0_4px_20px_rgba(0,0,0,0.3)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
        position === 'popper' &&
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ...
    className={cn('type-overline py-2 pl-6 pr-2 text-muted-foreground', className)}
    {...props}
  />
))
