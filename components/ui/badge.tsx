...
const badgeVariants = cva("inline-flex items-center justify-center gap-1 rounded-full border font-semibold transition-all duration-150 focus-visible:outline-none text-[11px] tracking-[0.04em]",
 {
 variants: {
 variant: {
