...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
 ...
 return (
 <textarea
 className={cn("field-sizing-content flex min-h-16 w-full rounded-md border border-border/30 bg-transparent px-3 py-2 text-base shadow-none transition-[color,box-shadow] outline-none placeholder:text-muted-foreground focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/50 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
