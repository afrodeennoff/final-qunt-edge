...
>(({ index, className, ...props }, ref) => {
 ...
 className={cn("relative flex h-10 w-10 items-center justify-center border-y border-r border-input text-sm transition-[opacity,background-color,border-color] first:rounded-l-md first:border-l last:rounded-r-md",
