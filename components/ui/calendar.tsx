...
function Calendar({
 ...
 weeks:"text-sm",
 week:"",
 day: cn("relative h-9 w-9 overflow-hidden rounded-md p-0 text-center align-middle","focus-within:z-20 focus-within:shadow-[inset_0_1px_0_hsl(var(--primary)/0.06),0_4px_16px_-4px_rgba(0,0,0,0.3)]"
 ),
 day_button: cn(
