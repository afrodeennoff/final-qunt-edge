  ...
  'type-body-sm inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap border select-none font-medium tracking-normal transition-[background-color,border-color,color,transform,box-shadow] duration-120 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 min-h-[40px] rounded-lg press-scale',
  {
    variants: {
      variant: {
        ...
        outline: 'border-[oklch(0.65_0.22_260/0.12)] bg-transparent text-foreground hover:bg-[oklch(0.65_0.22_260/0.04)] hover:border-[oklch(0.65_0.22_260/0.2)]',
        ...
        secondary: 'border-[oklch(0.65_0.22_260/0.12)] bg-[oklch(0.65_0.22_260/0.03)] text-foreground hover:bg-[oklch(0.65_0.22_260/0.06)]',
        mono: 'border-[oklch(0.65_0.22_260/0.12)] bg-[oklch(0.65_0.22_260/0.02)] text-foreground font-mono hover:bg-[oklch(0.65_0.22_260/0.04)]',
        pill: 'rounded-full border-[oklch(0.65_0.22_260/0.12)] bg-[oklch(0.65_0.22_260/0.02)] text-foreground hover:bg-[oklch(0.65_0.22_260/0.04)]',
        ...
        'gradient-secondary': 'border-[oklch(0.65_0.22_260/0.12)] bg-[oklch(0.65_0.22_260/0.03)] text-foreground hover:bg-[oklch(0.65_0.22_260/0.06)]',
