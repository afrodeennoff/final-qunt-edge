  ...
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[oklch(0.65_0.22_260/0.7)] disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden select-none",
  {
    variants: {
      variant: {
        ...
        outline: "border border-white/[0.12] bg-white/[0.03] text-foreground/95 rounded-xl hover:bg-white/[0.06] hover:border-white/[0.18] hover:scale-[1.01] active:scale-[0.98]",
        ghost: "text-muted-foreground rounded-xl hover:text-foreground/95 hover:bg-white/[0.06]",
        error: "bg-[oklch(0.64_0.255_22)] text-white rounded-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)] hover:bg-[oklch(0.70_0.255_22)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_8px_32px_-8px_rgba(0,0,0,0.4)] hover:scale-[1.01] active:scale-[0.98]",
        destructive: "bg-[oklch(0.64_0.255_22)] text-white rounded-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)] hover:bg-[oklch(0.70_0.255_22)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_8px_32px_-8px_rgba(0,0,0,0.4)] hover:scale-[1.01] active:scale-[0.98]",
        link: "text-[oklch(0.65_0.22_260)] underline-offset-4 hover:underline rounded-sm",
        "gradient-primary": "bg-gradient-to-r from-[oklch(0.65_0.22_260)] to-[oklch(0.60_0.20_280)] text-white rounded-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)] hover:shadow-[0_0_24px_oklch(0.65_0.22_260/0.35)] hover:scale-[1.015] active:scale-[0.975]",
        "gradient-secondary": "bg-gradient-to-br from-white/[0.07] to-white/[0.02] border border-white/[0.10] text-foreground/95 rounded-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)] hover:from-white/[0.10] hover:to-white/[0.04] hover:scale-[1.01] active:scale-[0.98]",
        shimmer: "bg-[oklch(0.65_0.22_260)] text-white rounded-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_4px_16px_-4px_rgba(0,0,0,0.3)]",
        ...
        pill: "bg-transparent text-foreground/95 border border-white/[0.12] rounded-full hover:bg-white/[0.06] active:bg-white/[0.04] active:scale-[0.98] transition-all duration-150",
        ...
        "pill-ghost": "bg-transparent text-muted-foreground border-none rounded-full hover:bg-white/[0.06] hover:text-foreground/95 active:bg-white/[0.04] transition-all duration-150",
      },
      size: {
