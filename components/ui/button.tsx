  ...
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap select-none cursor-pointer font-medium tracking-[-0.01em] transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-[130ms] ease-[cubic-bezier(0.16,1,0.3,1)] focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-[0_0_0_2px_var(--background),0_0_0_4px_var(--ring)/0.5] disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 active:scale-[0.982] active:duration-75",
  {
    variants: {
      variant: {
        ...
        'gradient-primary':
          "bg-gradient-to-b from-primary via-primary to-primary/88 text-primary-foreground border border-primary/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_4px_16px_-8px_rgba(139,92,246,0.40)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_8px_24px_-8px_rgba(139,92,246,0.50)]",
        'gradient-secondary':
      ...
      size: {
        sm: 'h-8 min-h-[32px] px-3 text-[13px] rounded-md gap-1 [&_svg]:size-3.5',
        default: 'h-9 min-h-[36px] px-4 text-[13px] rounded-md [&_svg]:size-4',
        md: 'h-10 min-h-[40px] px-5 text-[13px] rounded-[8px] [&_svg]:size-4',
        lg: 'h-11 min-h-[44px] px-6 text-[14px] rounded-[9px] [&_svg]:size-4',
        xl: 'h-12 min-h-[48px] px-7 text-[15px] rounded-[10px] [&_svg]:size-5',
        icon: 'h-9 w-9 min-h-[36px] min-w-[36px] rounded-md [&_svg]:size-4',
        'icon-sm': 'h-8 w-8 min-h-[32px] min-w-[32px] rounded-md [&_svg]:size-3.5',
        'icon-lg': 'h-10 w-10 min-h-[40px] min-w-[40px] rounded-[8px] [&_svg]:size-4',
      },
    },
    defaultVariants: {
      variant: 'solid',
