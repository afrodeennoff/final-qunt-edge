...
const GlassCard = React.forwardRef<HTMLDivElement, GlassCardProps>(
 ...
 (variant ==="default" || variant ==="strong" || variant ==="subtle") &&"relative rounded-xl border border-border/0.06 bg-background/0.08 backdrop-blur-[24px] backdrop-saturate-[1.8] shadow-[0_0_0_0.5px_rgba(180,210,255,0.07),0_8px_32px_-8px_rgba(0,0,0,0.78)]",
