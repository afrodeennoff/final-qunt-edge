  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer relative hidden overflow-hidden text-sidebar-foreground md:block",
          "duration-200 h-svh bg-transparent transition-[width] ease-linear",
          collapsible === "offcanvas"
      ...
      >
        <div
          className={cn(
            "duration-200 sticky top-0 hidden h-svh w-full transition-[width,padding] ease-linear md:flex",
            variant === "floating" || variant === "inset"
              ? "p-2"
              : "border-r border-sidebar-border/40 group-data-[side=right]:border-l group-data-[side=right]:border-r-0",
            className
          )}
...
const SidebarInput = React.forwardRef<
  React.ElementRef<typeof InputV2>,
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent/14 hover:text-sidebar-foreground focus-visible:ring-2 active:bg-sidebar-accent/18 active:text-sidebar-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent/18 data-[active=true]:font-medium data-[active=true]:text-sidebar-foreground data-[state=open]:hover:bg-sidebar-accent/18 data-[state=open]:hover:text-sidebar-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-sidebar-accent/14 hover:text-sidebar-foreground",
        outline:
          "bg-background border border-sidebar-border hover:bg-sidebar-accent/14 hover:text-sidebar-foreground hover:border-sidebar-accent/35",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
