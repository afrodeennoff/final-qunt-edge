...
export function SidebarLogoHeader() {
 ...
 <div className="flex aspect-square size-9 items-center justify-center rounded-[var(--radius-icon)] bg-gradient-to-br from-sidebar-primary/90 to-[oklch(0.7001_0.1882_313.2907)] text-sidebar-primary-foreground shadow-[0_0_12px_oklch(0.6083_0.2172_297.1153/0.30)] transition-[opacity,background-color,border-color] duration-300 group-hover:shadow-[0_0_18px_oklch(0.6083_0.2172_297.1153/0.42)]">
