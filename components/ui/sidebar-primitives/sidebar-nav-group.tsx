...
const ITEM_BUTTON_CLASS =
  'pointer-events-auto rounded-xl font-medium hover:text-sidebar-foreground data-[active=true]:text-sidebar-foreground transition-[opacity,background-color,border-color] duration-150'
const INACTIVE_ITEM_CLASS = 'text-sidebar-foreground/68'
const ACTIVE_ITEM_CLASS =
  'border-sidebar-primary/28 bg-sidebar-primary/12 text-sidebar-foreground shadow-none'
          ...
          {flatItems.map((item, index) => {
            ...
            return (
              <React.Fragment key={`${item.label}-${index}`}>
                {showSeparator && <div className="mx-3 my-1.5 h-px bg-sidebar-border/25" />}
