...
>(({ className, align ="center", sideOffset = 4, ...props }, ref) => (
 ...
 className={cn("z-50 w-[90vw] sm:w-72 rounded-xl border border-white/[0.08] bg-[oklch(0.048_0.005_264)] p-4 text-popover-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_4px_8px_rgba(0,0,0,0.06),0_12px_28px_rgba(0,0,0,0.32),0_48px_80px_-20px_rgba(0,0,0,0.92)] backdrop-blur-xl outline-none transition-all duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-(--radix-popover-content-transform-origin)",
 className
 )}
 {...props}
 />
