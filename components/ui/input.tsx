      ...
      <div className={cn("relative", containerClassName)}>
        <div className="relative flex items-center">
          ...
          <input
            ...
            type={type}
            className={cn(
              "flex h-9 w-full rounded-xl border border-white/[0.10] bg-white/[0.03] px-3.5 py-2 text-[13px] font-medium tracking-[-0.005em] text-foreground ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-foreground/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[oklch(0.65_0.22_260/0.55)] focus-visible:border-[oklch(0.65_0.22_260/0.40)] disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-150 hover:border-white/[0.16]",
              leftIcon && "pl-10",
              rightIcon && "pr-10",
