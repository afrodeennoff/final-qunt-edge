...
export const HoverLift = React.forwardRef<HTMLDivElement, HoverLiftProps>(
 ...
 <div
 ref={ref}
 className={cn("transition-[opacity,background-color,border-color] duration-200 ease-out","hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_16px_48px_-16px_rgba(0,0,0,0.5)] hover:shadow-foreground/20",
 `hover:${liftAmount}`,
 className
 )}
 {...props}
