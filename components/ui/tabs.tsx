...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 data-slot="tabs-list"
 className={cn("inline-flex min-h-10 items-center justify-center rounded-lg border border-[oklch(0.65_0.22_260/0.08)] bg-[oklch(0.65_0.22_260/0.03)] p-1 text-muted-foreground shadow-[inset_0_1px_0_oklch(0.65_0.22_260/0.06)]",
 className
 )}
 {...props}
 />
