...
export const TaskTrigger = ({
  ...
  <CollapsibleTrigger asChild className={cn("group", className)} {...props}>
    {children ?? (
      <div className="flex w-full cursor-pointer items-center gap-2 text-muted-foreground text-sm transition-colors hover:text-foreground/95">
...
export const TaskContent = ({
  ...
  <CollapsibleContent
    ...
    {...props}
  >
    <div className="mt-4 gap-2 border-muted border-l-2 pl-4">
      {children}
    </div>
  </CollapsibleContent>
);
